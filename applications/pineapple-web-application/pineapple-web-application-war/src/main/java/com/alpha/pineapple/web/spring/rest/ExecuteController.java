...
public class ExecuteController {
	 ...
	 * execution. Each index defines last result returned to client as part of an
	 * update request.
	 */
	 ...
	 * 
	 * @param id
	 *            the ID of executing operation. Used to identify execution result
	 *            tree.
	 ...
	 * 
	 * If the operation ID is known then a HTTP 200 (OK) is returned with a sequence
	 * of model results. If the operation ID isn't known the a HTTP 404 (Not Found)
	 * is returned along with a error message.
	 * 
	 * @param id
	 *            the ID of executing operation. Used to identify execution result
	 *            tree.
	 ...
	 * sequence of execution results which are generated since the last invocation
	 * of the service.
	 * 
	 * @param id
	 ...
	 * 
	 * @return If the operation ID is known then a HTTP 200 (OK) is returned with a
	 *         sequence of model results. If the operation ID isn't known the a HTTP
	 *         404 (Not Found) is returned along with a error message.
	 * 
	 * @throws ExecutionInfoNotFoundException
	 *             if operation ID isn't known. The exception is handled by the
	 *             spring exception handler.
	 ...
	 *         notifications are returned. If the operation ID isn't known the an
	 *         exception is thrown.
	 * 
	 * @throws ExecutionInfoNotFoundException
	 ...
	 *            execution info.
	 * 
	 * @return index of the first result to return in the result set. If no index is
	 *         defined for the execution then zero is returned.
	 */
