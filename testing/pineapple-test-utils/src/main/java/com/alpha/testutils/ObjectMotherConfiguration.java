...
public class ObjectMotherConfiguration {
	 ...
	 * 
	 * <p>
	 * the configuration is configured with XPathExpressionEngine and with delimiter
	 * parsing disabled.
	 * </p>
	 * 
	...
	/**
	 * Create null combined Configuration, i.e. an empty configuration object. Is
	 * configured with XPathExpressionEngine.
	 * 
	 * @return null XML Configuration
	 */
	...
	/**
	 * Add level-2 element named "level-2" to configuration with a null value, i.e.
	 * "". The property is added at the XPath location: /level-1/level-2.
	 * 
	 * @param config
	 *            The configuration to which the element is added.
	 */
	...
	/**
	 * Add level-2 element to configuration with a null value, i.e. "". The property
	 * is added at the XPath location:
	...
	/**
	 * Add level-2 element named "level-2" and level-3 element to configuration. The
	 * level-3 element can have variable name and value. The level3 element is added
	 * at the XPath location: /level1/level2/&lt;level3ElementName&gt;
	 * 
	 * @param config
	 *            The configuration to which the element is added.
	 * @param property
	...
	/**
	 * Add level-N element to configuration with a null value, i.e. "". The property
	 * is added at the XPath location: /&lt;nodeXPath&gt;/&lt;elementName&gt;.
	 * 
	 * @param config
	 *            The configuration to which the element is added.
	 *
	...
	/**
	 * Add attribute to level-2 element named "level-2" with a level-3 element named
	 * "Name" depending on value of the Name element. The attribute can have
	 * variable name and value. The attribute is added at the XPath location:
	 * /level1/level2/[Name=??]
	 * 
	 * 
	 * @param config
	 *            The configuration to which the element is added.
	 * @param level2Name
	 *            The name of the level2 element to which the attribute is added.
	 * @param attrName
	 *            The name of the attribute
	 * @param attrValue
	 *            The value of the attribute.
	 ...
	 * @param fqFileName
	 *            Fully qualified path to where the configuration should be saved.
	 */
	...
	/**
	 * Create and save XMLCofiguration with a two level-2 properties with a child
	 * name element.
	 * 
	 * @param property
	 *            Value of the child elements. The properties are post fixed with
