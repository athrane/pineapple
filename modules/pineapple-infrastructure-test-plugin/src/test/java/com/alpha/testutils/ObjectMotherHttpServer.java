 ...
 * provides helper functions for creating HTTP server instances.
 * 
...
public class ObjectMotherHttpServer {
     ...
     * Get host IP address.
     * 
     * @param isLocalHost If true then 127.0.0.1 is return.
     * 
     * @return IP address of the current machine. 
     * If the parameter is true then 127.0.0.1 is returned.
     */
    ...
    /**
     * Create HTTP server, which redirects from "/redirect" to "/sniffer"
     * returning http status code 301. 
     * 
     * @param host Host name. 
     * @param port Port number.
     * 
    ...
    /**
     * Create HTTP server, which redirects from "/redirect" to "/sniffer"
     * returning http status code 302. 
     * 
     * @param host Host name. 
     * @param port Port number.
     * 
    ...
    /**
     * Create HTTP server, which redirects from "/redirect" to "/sniffer"
     * returning http status code 303. 
     * 
     * @param host Host name. 
     * @param port Port number.
     * 
    ...
    /**
     * Create HTTP server, which redirects from "/redirect" to "/sniffer"
     * returning http status code 304. 
     * 
     * @param host Host name. 
     * @param port Port number.
     * 
    ...
    /**
     * Create HTTP server, which redirects from "/redirect" to "/sniffer"
     * returning http status code 305. 
     * 
     * @param host Host name. 
     * @param port Port number.
     * 
    ...
    /**
     * Create HTTP server, which redirects from "/redirect" to "/sniffer"
     * returning http status code 306. 
     * 
     * @param host Host name. 
     * @param port Port number.
     * 
     ...
     * @param host Host name. 
     * @param port Port number.
     * @param httpStatusCode HTTP status returned by servlet
     * 
     * @return Configured HTTP server. 
     */    
    public Server createHttpServerWithRedirect(String host, int port, int httpStatusCode) {
        ...
        try {       	
            ...
            // add servlets                                    
            context.addServlet(new ServletHolder(new SnifferServlet()),"/sniffer");
            context.addServlet(new ServletHolder(new ConfigurableRedirectServlet("/redirect","/sniffer", httpStatusCode)),"/redirect");            
            EnumSet<DispatcherType> dispatches = EnumSet.of(DispatcherType.REQUEST);
			context.addFilter(new FilterHolder(new JSessionIdSetterFilter()), "/*",  dispatches);
