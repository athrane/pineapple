...
public class DefaultResultTriggerResolverImplTest {
	...
	/**
	 * Trigger with result wild card with leading space is resolved for execution.
	 */
	@Test
	...
	/**
	 * Trigger with result wild card with trailing space is resolved for execution.
	 */
	@Test
	...
	/**
	 * Trigger with result with list with two results is resolved for execution. One
	 * result is matched.
	 */
	@Test
	...
	/**
	 * Trigger with result list with two results is resolved for execution. The list
	 * contains two identical results. One result is matched.
	 */
	@Test
	...
	/**
	 * Trigger with result list with two results is resolved for execution. The list
	 * contains two results which differ from the expected state. No results are
	 * matched.
	 */
	@Test
