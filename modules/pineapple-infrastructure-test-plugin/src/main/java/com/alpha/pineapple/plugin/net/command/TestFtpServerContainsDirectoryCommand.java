 ...
 * tests whether a FTP server contains a requested directory.</p>
 * 
...
public class TestFtpServerContainsDirectoryCommand implements TestCommand
{
     ...
     * 
     * @param splitDirs Array of directories in the path. 
     * 
     ...
     * @param newDirectory The name of a single directory that the FTP client 
     * should change to. The string ".." is valid parameter will change to the 
     * parent directory.
     *  
