...
public class ObjectMotherContent {
	...
	/**
	 * Create map with single model HTTP Configuration with default configuration.
	 * The configuration object has the key "default-config".
	 * 
	 ...
	 * @param headers
	 *            Map of HTTP headers.
	 * @param nonPresentheaders
	 *            Array of non existing HTTP headers.
	 * 
	 * @return model HTTP redirect test case.
	 */
	public HttpHeaderTest createHttpHeaderTest(String url, HashMap<String, String> headers,
			String[] nonPresentheaders) {
