...
public class VariableSubstitutedProxyFactoryIntegrationTest {
    ...
    /**
     * Test that string supplied as argument to the factory is returned
     * unmodified if it doesn't contain any variables.
     */
    @Test
    ...
    /**
     * Test that model with class with public n-arg constructor can be handled
     * and proxied.
     * 
    ...
    /**
     * Test that model with class with public n-arg constructor can be handled
     * and proxied. Example used: JaxbElement
     */
    @Test
    ...
    /**
     * Test that model with class with n-arg constructor can be handled and
     * proxied.
     * 
    ...
    /**
     * Test that model with class with public no-arg constructor can be handled
     * and proxied.
     * 
    ...
    /**
     * Test that model with class with private no-arg constructor can be handled
     * and proxied.
     * 
    ...
    /**
     * Test that model with private class with no-arg constructor can be handled
     * and proxied. Example used: {@linkplain ArrayList$Itr}
     */
    @Test
