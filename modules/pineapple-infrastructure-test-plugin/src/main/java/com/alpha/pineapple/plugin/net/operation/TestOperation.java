...
public class TestOperation implements Operation
{
    ...
    void runStickynessTests( Infrastructure model, HashMap<String, HttpConfiguration> httpConfigMap ) throws CommandException
    {
    ...
    void runLoadBalancingTests( Infrastructure model, HashMap<String, HttpConfiguration> httpConfigMap ) throws CommandException
    {
    ...
    void runHttpStatusCodeTests( Infrastructure model, HashMap<String, HttpConfiguration> httpConfigMap ) throws CommandException
    {
    ...
    void runHttpRedirectTests( Infrastructure model, HashMap<String, HttpConfiguration> httpConfigMap ) throws CommandException
    {
    ...
    void runHttpHeaderTests( Infrastructure model, HashMap<String, HttpConfiguration> httpConfigMap ) throws CommandException
    {
    ...
    void runFtpServerActiveTests( Infrastructure model ) throws CommandException
    {
        ...
        for ( FtpServerActiveTest test : model.getFtpServerActiveTest() )
        {
            ...
            // run test            
            //commandRunner.run(testResolveNameToIpAddressCommand, description.toString(), context);        	        	        	
        }
    }
