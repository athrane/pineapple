 ...
 * 1) The header array contains the expected number of headers.
 * 2) The header array contains the expected header names. 
 * 3) The headers in the array contains the expected values. 
 * </p>  
 */
public class IsHeadersContaining extends TypeSafeMatcher<Header[]> {
     ...
     * 
     * @param expectedHeaders Array of expected HTTP headers.
     */
     ...
     * IsHeadersContaining constructor.
     * 
     * @param expectedHeaders Map of header name and values..
     */	
	...
	protected boolean matchesSafely(Header[] headers) {
		...
		if (expectedHeaders.isEmpty()) return true;
		...
		if (!keysMatcher.matches( headerMap ) ) return false;
	 ...
	 * Create header array
	 * 
	 * @param Map of header name and values..
	 * 
	 ...
	 * 
	 * @param actualHeaders Map of actual HTTP headers.
	 * 
