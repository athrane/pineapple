 ...
 * address and that a reverse DNS lookup can resolve an IP address to a host
 * name.
 * </p>
 * 
 * <p>
 * If the the IP address is undefined then a forward DNS lookup is attempted and
 * the resolved IP address is used to do a reverse DNS lookup to verify that the
 * IP address can be resolved back to the host name.
 * </p>
 * 
 * <p>
