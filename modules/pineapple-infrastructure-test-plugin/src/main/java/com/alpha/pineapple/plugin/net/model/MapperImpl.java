...
public class MapperImpl implements Mapper {
	...
	public void mapHttpHeaderTest(HttpHeaderTest test, Context context,
		...
		mapHttpConfiguration(test.getHttpConfigurationRef(), context, configurationMap,
	...
	public void mapHttpRedirectTest(HttpRedirectTest test, Context context,
		...
		httpConfig = (com.alpha.pineapple.plugin.net.http.HttpConfiguration) context
				.get(TestHttpCommand.HTTPCONFIGURATION_KEY);
	...
	public void mapLoadBalancingTest(LoadBalancingTest test, Context context,
		...
		// initialize and map assertions into the context
		assertionConfigurations.initializeHttpLoadBalancingTestProperties(context, environment, host, location,
				servers);
	}
	 ...
	 * 
	 * @param assertion
	 *            Model assertion which is mapped into an response property.
	 * @param properties
	 *            Response properties container to which the property is added.
	 */
	 ...
	 * 
	 * @return initialized matcher object with the constructor initialized with the
	 *         array of constructor values.
	 */
	...
	/**
	 * Map source HTTP configuration form model to target HTTP Configuration for
	 * command objects and store the target HTTP configuration object in the command
	 * context.
	 * 
	 * @param configId
	 *            Id of Model configuration object.
	 * @param context
	 *            Context where HTTP configuration is added to.
	 * @param configurationMap
	 *            Map of source HTTP configuration objects.
	 * @param configKey
	 *            Key in the context where the target HTTP configuration object is
	 *            stored under.
	 */
	@SuppressWarnings("unchecked")
	void mapHttpConfiguration(String configId, Context context, HashMap<String, HttpConfiguration> configurationMap,
			String configKey) {
	...
	/**
	 * Map URLs string array and store it in the context. If no URLs are defined in
	 * the model then an empty array is stored.
	 * 
	 * @param urlsContainer
	 *            Model URLs container object where the URL's are read from.
	 * @param context
	 *            Context where the string array is added to
	 * @param configKey
	 *            Key in the context where the URLS are stored.
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * 
	 * @param url
	 *            The URL which is mapped into the string array.
	 * @param context
	 *            The context where the string array is stored.
	 * @param configKey
	 *            Key in the context where the URLS are stored.
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * Map servers to a string array. If no servers are defined in the model then an
	 * empty array is returned.
	 * 
	 * @param servers
	 *            Source model servers element.
	 * 
