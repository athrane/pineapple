...
public class DefaultOperation implements Operation
{
	 ...
	 * 
	 * @param session SSH session.
	 * @param command secure copy command.
	 ...
	 * 
	 * @param session SSH session.
	 * @param command remote execute command.
	 * @param result operation result.
	 */
		...
		try {						
			...
			while(true) {				
			    ...
			    if(execChannel.isClosed()) {
                    ...
                    addCommandOutputToResult(commandResult, "Standard Out", new ByteArrayInputStream(byteArrayOutputStream.toByteArray()));
                    addCommandOutputToResult(commandResult, "Error Out", new ByteArrayInputStream(byteArrayErrorStream.toByteArray()));
			    	break;			    	
			    } 
	 ...
	 * 
	 * @param session SSH session.
	 * @param command assert equals command.
	 * @param result operation result.
	 */
	 ...
	 */
	boolean assertExpectedValue(ExecutionResult result, String cmdExpectedValue, String stdoutMessage) throws Exception {
	 ...
	 * Assert remote command output versus expected value. 
	 */
	boolean assertContainsValue(ExecutionResult result, String cmdExpectedValue, String stdoutMessage) throws Exception {
		String message = stdoutMessage.trim();
	 ...
	 * 
	 * @param result execution result.
	 * @param in input stream where is read from.
	 * 
	 ...
	 * 
	 * @param result result where status code is added.
