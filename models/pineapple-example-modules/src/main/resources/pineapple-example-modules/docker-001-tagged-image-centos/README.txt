...
Description
-------------
This example illustrates how the Docker plugin can be used to create a tagged image
...
Intended operations
-----------------------
* "deploy-configuration"  - which will create the tagged Docker image from the existing image.
* "undeploy-configuration"  - which will delete the tagged Docker image.
