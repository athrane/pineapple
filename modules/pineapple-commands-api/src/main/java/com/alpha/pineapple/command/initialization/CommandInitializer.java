...
public interface CommandInitializer
{
     ...
     *  
     * @param context The context object to map values from.
     * @param command The command object where the values are mapped into fields.
     * 
     * @throws CommandInitializationFailedException If the context doesn't contains 
     * the key defined by an instance of the annotation {@link @Initialize}.
     */
