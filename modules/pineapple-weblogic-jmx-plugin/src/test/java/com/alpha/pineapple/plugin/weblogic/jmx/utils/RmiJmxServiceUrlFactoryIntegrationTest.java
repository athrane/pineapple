...
/**
 * Integration test of the {@linkplain RmiJmxServiceUrlFactoryImpl} class. 
 */
@RunWith( SpringJUnit4ClassRunner.class )
@ContextConfiguration( locations = { "/com.alpha.pineapple.plugin.weblogic.jmx-config.xml" } )
public class RmiJmxServiceUrlFactoryIntegrationTest {

	/**
	 * Subject under test. 
	 */
	@Resource(name="rmiJmxServiceUrlFactory")
	...
	public void testCreateEditMBeanServerUrlForRmi() throws Exception {
		...
		JMXServiceURL url = factory.createEditMBeanServerUrl(JmxProtool.RMI, randomHost, randomPort);				
