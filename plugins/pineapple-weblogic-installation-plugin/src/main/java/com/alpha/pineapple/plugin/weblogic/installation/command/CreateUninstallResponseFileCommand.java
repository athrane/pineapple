...
import static com.alpha.pineapple.plugin.weblogic.installation.WeblogicInstallationConstants.RESPONSE_UNINSTALL_FILE;
 ...
 * creates a response file for uninstallation of WebLogic (12.1.2+) using the Oracle universal installer. 
 * 
...
public class CreateUninstallResponseFileCommand implements Command {
    ...
    /**
	 * Create response file for uninstallation.
     * 
     * @param context
     *            Command context.
     * 
