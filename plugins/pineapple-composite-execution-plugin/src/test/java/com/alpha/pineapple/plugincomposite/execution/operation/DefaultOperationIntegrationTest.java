...
public class DefaultOperationIntegrationTest {
    ...
    /**
     * EasyMock Answer which sets the state of the execution result in the
     * captured execution info object.
     */
    ...
    /**
     * Test that the operation can execute with a single composite with null
     * name.
     */
    @Test
     ...
     * empty name. Composite completes with failure which is propagated to the
     * root result.
     */
    @Test
