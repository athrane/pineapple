...
/**
 * Implementation of the {@link VfsUriGenerator} interface for the HTTP protocol.
 */
public class HttpUriGeneratorImpl extends AbstractUriGeneratorImpl {

	/**
	 * HttpUriGeneratorImpl constructor.
	 * 
	 ...
	 */
	public HttpUriGeneratorImpl(String host, String port, String user, String password) {
