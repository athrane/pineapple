...
public class ScheduleControllerIntegrationTest {
    ...
    /**
     * Test that Get "Get Scheduled Operations" service invocation returns HTTP
     * 200.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that GET "Get Scheduled Operations" service invocation returns
     * content.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that POST "Schedule Operation" service invocation returns HTTP 500
     * for illegal scheduling expression.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that Delete "Delete Scheduled Operation" service invocation returns
     * HTTP 200.
     * 
     * @throws Exception
     *             if test fails.
