...
import static com.alpha.testutils.DockerTestConstants.*;
...
public class DockerTestHelper {
    ...
    /**
     * Create image info for default CentOS image, e.g.
     * "pineapple_ci/centos"
     * 
     * @return image info for root CentOS image.
     */
     ...
     * "pineapple_ci/centos" repository which is intended to be used
     * by tests.
     * 
     * @param session
     *            Docker session.
     ...
     *             if query fails.
     */
    public InspectedContainer inspectContainer(DockerSession session, ContainerInfo info) throws Exception {
	try {
