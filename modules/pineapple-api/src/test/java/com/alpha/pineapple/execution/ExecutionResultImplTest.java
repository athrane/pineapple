...
public class ExecutionResultImplTest {
    ...
    /**
     * test that internal stop watch is stopped when the execution state is
     * changed from executing to computed.
     */
    @Test
    ...
    /**
     * test that internal stop watch is stopped when the execution state is
     * changed from executing to successful.
     */
    @Test
    ...
    /**
     * test that internal stop watch is stopped when the execution state is
     * changed from executing to error.
     */
    @Test
    ...
    /**
     * test that internal stop watch is stopped when the execution state is
     * changed from executing to failure.
     */
    @Test
    ...
    /**
     * test that internal stop watch isn't started if the execution state is
     * changed to executing from another state.
     */
    @Test
    ...
    /**
     * test that internal stop watch is stopped when the execution state is
     * changed from executing to interrupted.
     */
    @Test
    ...
    /**
     * Test that a failure in a child is propagated to a parent result when
    ...
    /**
     * Test that a success in a child is propagated to a parent result when
     * parent state is computed.
     */
    @Test
    ...
    /**
     * Test that a computed child state is propagated to a parent result when
     * parent state is computed.
     */
    @Test
    ...
    /**
     * Test that a interrupted child state is propagated to a an already
     * completed (successfully) parent.
     */
    @Test
    ...
    /**
     * Test that a success in a child isn't propagated propagated to a failed
     * parent result, when parent state is computed.
     */
    @Test
    ...
    /**
     * Test that the state of a running child running child updated to error,
     * when parent state is computed. Which means that the error state
    ...
    /**
     * Test that a success in a child isn't propagated to a parent result with
     * an error.
     */
    @Test
    ...
    /**
     * Test that a failure in a child isn't propagated to a parent result with
     * an success.
     */
    @Test
     ...
     * field but that it only contains a single message line despite the
     ...
     * Test that a re-computation replaces composite execution result text.
     * 
     * It is asserted that the two generated composite execution result texts
     * are different (a child is added to the second).
     * 
     * It is asserted that the second computation replaces the first message
     * despite the multiple computations.
     */
    @Test
    ...
    /**
     * Test that get first child return same child result event if multiple
     * children are added.
     */
    @Test
