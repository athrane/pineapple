...
public class ResourceRespositoryIntegrationTest {
	...
	/**
	 * Initialization of repository with no environments, deletes previous defined
	 * environments.
	 */
	@Test
	...
	/**
	 * Repository can be initialized with configuration with multiple environments.
	 */
	@Test
	...
	/**
	 * Get resource method throws exception if id is unknown in primary environment.
	 * Primary environment is defined, with no resource. Wild card environment isn't
	 * defined.
	 */
	...
	/**
	 * Get resource method can look up resource directly in wild card environment.
	 * Primary environment is defined, with no resource. Wild card environment is
	 ...
	 * card environment. Primary environment is defined, with no resource. Wild card
	 ...
	 * 
	 * Primary environment isn't defined. Wild card environment is defined, resource
	 * is defined.
	 */
	@Test
	...
	/**
	 * Contains resource method can look up resource in primary environment. Primary
	 * environment is defined, resource is defined. Wild card environment isn't
	 * defined.
	 */
	@Test
	...
	/**
	 * Contains resource method returns false if id is unknown in primary and wild
	 * card environment. Primary environment is defined, with no resource. Wild card
	 * environment is defined, with no resource.
	 */
	@Test
	...
	/**
	 * Contains resource method can look up resource in wild card environment if the
	 * primary environment isn't defined.
	 * 
	 * Primary environment isn't defined. Wild card environment is defined, resource
	 * is defined.
	...
	/**
	 * Repository can create resource with: plugin id references existing plugin on
	 * class path, no properties, null credential ID reference.
	 */
	@Test
	...
	/**
	 * Repository can create resource with: plugin id references existing plugin on
	 * class path, no properties, empty credential ID reference.
	 */
	@Test
	...
	/**
	 * Delete resource method throws exception if resource is unknown. Environment
	 * is defined, but resource isn't.
	 */
	@Test(expected = ResourceNotFoundException.class)
	...
	/**
	 * Repository can delete resource property in wild card environment. Property is
	 * deleted through the wild card environment.
	 */
	@Test
	...
	/**
	 * Repository can delete resource property in wild card environment. Property is
	 * deleted through the primary environment.
	 */
	@Test
