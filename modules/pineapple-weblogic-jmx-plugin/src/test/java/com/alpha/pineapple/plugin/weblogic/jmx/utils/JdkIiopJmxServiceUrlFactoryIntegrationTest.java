...
/**
 * Integration test of the {@linkplain JdkIiopJmxServiceUrlFactoryImpl} class. 
 */
@RunWith( SpringJUnit4ClassRunner.class )
@ContextConfiguration( locations = { "/com.alpha.pineapple.plugin.weblogic.jmx-config.xml" } )
public class JdkIiopJmxServiceUrlFactoryIntegrationTest {

	/**
	 * Subject under test. 
	 */
	@Resource(name="jdkIiopJmxServiceUrlFactory")
	...
	public void testCreateEditMBeanServerUrlForIIOP() throws Exception {
		...
		JMXServiceURL url = factory.createEditMBeanServerUrl(JmxProtool.JDK_IIOP, randomHost, randomPort);					
