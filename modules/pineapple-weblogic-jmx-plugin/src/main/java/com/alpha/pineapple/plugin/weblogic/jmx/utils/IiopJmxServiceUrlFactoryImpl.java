 ...
 * for creation of IIOP based service URLs which uses the Oracle implementation
 * of the HTTP and IIOP protocols bundled with WebLogic (WL_HOME\lib\wljmxclient.jar).
 */
public class IiopJmxServiceUrlFactoryImpl implements JmxServiceUrlFactory {
    ...
    public JMXServiceURL createEditMBeanServerUrl(JmxProtool protocol, String host, int port) throws Exception {
		if((protocol != JmxProtool.IIOP) && (protocol != JmxProtool.IIOPS)) {			
