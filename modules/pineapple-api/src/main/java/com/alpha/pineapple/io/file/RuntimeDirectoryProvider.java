...
public interface RuntimeDirectoryProvider {
     ...
     * <code>&#036;&#123;user.home&#125;<code> is the value of the system
     * property.
     * 
    ...
    /**
     * Get a runtime child directory local to the home directory where Pineapple
     * is running from.
     * 
     * The default value for this directory is
     * <code>&#036;&#123;user.home&#125;&#047;.pineapple&#047;&#036;&#123;child.
     * dir&#125;<code> where <code>&#036;&#123;user.home&#125;<code> is the
     * value of the system property and <code>&#036;&#123;child.dir&#125;
     * <code> is the value of the <code>childDirectory<code> child argument.
     * 
     * @return a runtime child directory local to the runtime root directory
     *         where Pineapple is running from.
     */
     ...
     * 
     * The default value for this directory is
     * <code>&#036;&#123;user.home&#125;&#047;.pineapple&#047;modules&#125;
     * <code> where <code>&#036;&#123;user.home&#125;<code> is the value of the
     * system property
     * 
     ...
     * 
     * The default value for this directory is
     * <code>&#036;&#123;user.home&#125;&#047;.pineapple&#047;reports&#125;
     * <code> where <code>&#036;&#123;user.home&#125;<code> is the value of the
     * system property
     * 
    ...
    /**
     * Get the absolute runtime temporary directory where Pineapple is running
     * from.
     * 
     * The default value for this directory is
    ...
    /**
     * Resolve model path to the physical path where the module is located on
     * disk, e.g. the module directory. A model element path is a path
     * definition which occurs in a module model which starts with the prefix
     * 'modulepath:'.
     * 
     * If the model path dosn't start with the 'modulepath:' prefix then the
     * path is resolved from a string into a File object.
     * 
     * @param path
     *            Model element path.
     * @param info
     ...
     * look for the file which contains the master password for symmetric
     * encryption of credentials.
     * 
     * The default value for this location is
     * <code>&#036;&#123;pineapple.home.dir&#125;&#047;conf&#047;
     * credentialprovider.password&#125;<code> where
     * <code>&#036;&#123;pineapple.home.dir&#125;<code> is the value of the
     * system property
     * 
     * @return the file location where Pineapple should look for its password
     *         file for symmetric encryption of credentials.
     */
