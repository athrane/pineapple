...
/**
 * Goal which executes a Pineapple deploy-application operation on the Maven 
 ...
 * @goal undeploy-app 
 */
public class UndeployApplicationMojo extends AbstractOperationMojo
{

    @Override
    public String getOperation()
    {
        return OperationNames.UNDEPLOY_APPLICATION;
    }
