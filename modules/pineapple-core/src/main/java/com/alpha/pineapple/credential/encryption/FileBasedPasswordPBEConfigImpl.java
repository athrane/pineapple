...
public class FileBasedPasswordPBEConfigImpl implements PBEConfig {
     ...
     * </p>
     * <p>
     * This algorithm has to be supported by your JCE provider and, if this
     * provider supports it, you can also specify <i>mode</i> and <i>padding</i>
     * for it, like <tt>ALGORITHM/MODE/PADDING</tt>.
     * </p>
     * <p>
    ...
    /**
     * Sets the number of hashing iterations applied to obtain the encryption
     * key.
     * <p>
     ...
     * </p>
     * <p>
     * If both the <tt>providerName</tt> and <tt>provider</tt> properties are
     * set, only <tt>provider</tt> will be used, and <tt>providerName</tt> will
     * have no meaning for the encryptor object.
     * </p>
     * <p>
     ...
     * algorithm. This method is an alternative to both
     * {@link #setProviderName(String)} and
     * {@link #setProviderClassName(String)} and they should not be used
     * altogether. The provider specified with {@link #setProvider(Provider)}
     * does not have to be registered beforehand, and its use will not result in
     ...
     * Sets the security provider to be used for obtaining the encryption
     * algorithm. This method is an alternative to both
     * {@link #setProviderName(String)} and {@link #setProvider(Provider)} and
     * they should not be used altogether. The provider specified with
     * {@link #setProviderClassName(String)} does not have to be registered
     * beforehand, and its use will not result in its being registered.
     * </p>
     * <p>
     * If both the <tt>providerName</tt> and <tt>provider</tt> properties are
     * set, only <tt>provider</tt> will be used, and <tt>providerName</tt> will
