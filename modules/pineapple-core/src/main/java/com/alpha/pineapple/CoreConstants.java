...
public interface CoreConstants {
    ...
    /**
     * Execution capacity of current and past executions in the result
     * repository.
     */
    ...
    /**
     * Execution result key used to messages concerning operation session
     * handling info.
     */
    ...
    /**
     * Execution result key used to messages identifying the continuation
     * policy.
     */
    public static final String MSG_CONTINUATION = "Continuation";

    /**
     * Execution result key used to messages identifying the resource
     * resolution.
     */
