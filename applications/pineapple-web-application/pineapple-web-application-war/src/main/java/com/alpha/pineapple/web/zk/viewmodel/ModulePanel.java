...
public class ModulePanel {
	...
	/**
	 * Returns the value of confirm model deletion flag. If the flag is true then
	 * the model deletion modal windows is enabled.
	 * 
	...
	/**
	 * Event handler for the global command "createModel". The event is triggered
	 * from the menu controller and the module panel which posts the global command.
	 * 
	 ...
	 * 
	 * Step 2) of create a model. Will create model with returned environment from
	 * the modal window The model is created in the core component using REST API.
	 * 
	 * @param environment
	 *            from modal window.
	 */
	...
	/**
	 * Event handler for the global command "deleteModel". The event is triggered
	 * from the menu controller and the module panel which posts the global command.
	 * 
	...
	/**
	 * Event handler for the command "deleteModelCancelled". The event is triggered
	 * from the confirm deletion modal window.
	 * 
	...
	/**
	 * Event handler for the global command "saveModel". The event is triggered from
	 * the menu bar as a global command.
	 * 
	 * The event handler will start the process of saving a document by invoking a
	 * client side java script which requests the document from the editor for
	 * saving.
	 */
	@GlobalCommand
	 ...
	 * from the menu controller and the module panel which posts the global command.
	 * 
	 * Step 1) of opening a module. Will open a model window for module selection.
	 */
	@GlobalCommand
	 ...
	 * {@linkplain OpenModuleActivityInvokerImpl} which posts the global command.
	 * 
	...
	/**
	 * Event handler for the global command "downloadModel". The event is triggered
	 * from the menu bar as a global command.
	 * 
	 * The event handler will save the selected model at the client side, e.g. the
	 * browser.
	 */
	@GlobalCommand
