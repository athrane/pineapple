...
public class ConfigurationControllerIntegrationTest {
    ...
    /**
     * Test that POST "Refresh Environment Configuration" service invocation
     * returns HTTP 200.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that POST "Refresh Environment Configuration" service invocation
     * returns HTTP 501 if refresh fails.
     * 
    ...
    /**
     * Test that GET "Refresh Environment Configuration" service invocation
     * fails with HTTP 405.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that POST "Create Environment" service invocation returns no
     * content.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that POST "Create Environment" service invocation creates
     * environment in resources repository.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that POST "Create Environment" service invocation creates
     * environment in credential provider.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that POST "Create Environment" service invocation returns HTTP 201
     * if invoked with the same parameters twice.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that POST "Create Environment" service invocation returns HTTP 201
     * even if environment already exists in resource repository.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that POST "Create Environment" service invocation returns HTTP 201
     * event if environment already exists in credential provider.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that PUT "Update Environment" service invocation updates the
     * environment ID in the resource repository and the credential provider.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that PUT "Update Environment" service invocation updates the
     * environment description in the resource repository and the credential
     * provider.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that PUT "Update Environment" service invocation fails if
     * environment is unknown in the resource repository.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that PUT "Update Environment" service invocation fails if
     * environment is unknown in the credential provider.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that DELETE "Delete environment" service invocation returns HTTP
     * 200.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that DELETE "Delete environment" service invocation returns no
     * content.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that DELETE "Delete environment" service invocation deletes
     * environment in credential provider.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that DELETE "Delete environment" service invocation deletes
     * environment in resource repository.
     * 
     * @throws Exception
     *             if test fails.
     */
     ...
     * and deletes environment in resource repository.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that DELETE "Delete environment" service invocation returns HTTP 200
     * and deletes environment in credential provider.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that POST "Create Credential" service invocation creates credential
    ...
    /**
     * Test that DELETE "Delete Credential" service invocation returns no
     * content.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that DELETE "Delete Credential" service invocation deletes
     * credential in credential provider.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that DELETE "Delete Credential" service invocation returns HTTP 404
     * if credential doesn't exists in credential provider.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that DELETE "Delete Credential" service invocation returns HTTP 404
     * if environment doesn't exists in credential provider.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that PUT "Update Credential" service invocation updates with
     * identical values.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that PUT "Update Credential" service invocation fails with empty
     * request model.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that PUT "Update Credential" service invocation fails with request
     * model - model is defined but no environments.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that PUT "Update Credential" service invocation fails with request
     * model - model is defined but one environment and no credentials.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that PUT "Update resource" service invocation environment in the
     * request body is ignored. The resource isn't moved to another environment.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that PUT "Update resource" service invocation fails if resource
     * doesn't exist.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that POST "Create Resource Property" service invocation creates
     * resource property in resource repository.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that POST "Create Resource Property" service invocation returns HTTP
     * 500 if resource property already exists in repository.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that POST "Create Resource Property" service invocation returns HTTP
     * 404 if environment doesn't exist.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that POST "Delete Resource Property" service invocation delete
    ...
    /**
     * Test that POST "Delete Resource Property" service invocation returns HTTP
     * 404 if resource property doesn't exists in repository.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that POST "Delete Resource Property" service invocation returns HTTP
     * 404 if resource doesn't exists in repository.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that POST "Delete Resource Property" service invocation returns HTTP
     * 404 if environment doesn't exists in repository.
     * 
     * @throws Exception
     *             if test fails.
     */
