...
public class MatchingSingleValueInRangeTest {
	...
	/**
	 * Test that matcher succeeds 
	 * with range of two different values and zero values in matched collection. 
	 */
	@Test
	...
	/**
	 * Test that matcher succeeds 
	 * with range of two different values 
	 * and one value in matched collection with is defined in range. 
	 */	
	@Test
	 ...
	 * Test that matcher succeeds 
	 * with range of two different values 
	 * and two identical values in matched collection with is defined in range. 
	 */		
	@Test
	 ...
	 * with range of zero values 
	 * and two different values in matched collection with is defined in range. 
	 */		
	@Test
