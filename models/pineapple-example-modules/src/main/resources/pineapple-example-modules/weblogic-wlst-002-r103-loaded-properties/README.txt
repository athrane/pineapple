...
Description
-------------
This example illustrates how to invoke a WLST script which loads
properties from a property file in WebLogic 10.3.  
...
* "bin/script.properties" - WLST property file.
