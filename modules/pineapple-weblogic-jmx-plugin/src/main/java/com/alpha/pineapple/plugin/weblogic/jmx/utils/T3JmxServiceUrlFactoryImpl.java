 ...
 * for creation of T3 and T3S based service URLs.
 */
public class T3JmxServiceUrlFactoryImpl implements JmxServiceUrlFactory {
    ...
    public JMXServiceURL createEditMBeanServerUrl(JmxProtool protocol, String host, int port) throws Exception {	
		if((protocol != JmxProtool.T3) && (protocol != JmxProtool.T3S)) {			
        	Object[] args = { protocol };    	        	
        	String message = messageProvider.getMessage("t3jsuf.error", args );
