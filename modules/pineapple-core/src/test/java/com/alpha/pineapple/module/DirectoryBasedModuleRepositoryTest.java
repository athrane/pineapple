...
public class DirectoryBasedModuleRepositoryTest {
    ...
    /**
     * Test that repository doesn't contain any modules if location doesn't
     * exist.
     */
    @Test
    ...
    /**
     * Test that module can be initialized which contains a module.xml file and
     * no models directory and model files.
     */
    @Test
    ...
    /**
     * Test that repository can be refreshed to reflect the addition of new
     * modules.
     */
    @Test
