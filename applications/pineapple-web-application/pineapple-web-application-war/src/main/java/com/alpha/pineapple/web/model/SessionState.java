...
public interface SessionState {
     ...
     * 
     * @return value which is set to true if debug information should be shown
     *         in the application.
     */
     ...
     * 
     * @return name of last executed operation. If no operation has been
     *         executed previously then an empty is returned.
     */
