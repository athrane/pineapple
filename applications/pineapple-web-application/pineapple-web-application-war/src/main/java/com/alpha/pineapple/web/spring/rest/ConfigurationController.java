...
public class ConfigurationController {
	 ...
	 * 
	 * Will re-initialize the core component by creating a core component instance
	 * from web application factory.
	 * 
	...
	public void createCredential(@PathVariable String environment, @PathVariable String credential,
			...
			throws com.alpha.pineapple.credential.EnvironmentNotFoundException, CredentialAlreadyExitsException {
