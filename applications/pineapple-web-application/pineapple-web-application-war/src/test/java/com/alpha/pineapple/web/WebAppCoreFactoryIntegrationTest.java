...
public class WebAppCoreFactoryIntegrationTest {
    ...
    /**
     * Test that factory is initialized by the Spring context configuration as
    ...
    /**
     * Test that core component configured by web application core factory as
     * part of the Spring configuration is configured with report generator.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test core component returned by factory is same instance which is created
     * by Spring context,
     * 
     * The core component initializes is runtime directories from the pineapple
     * system property.
    ...
    /**
     * Test that core component created by web application core factory as part
     ...
     * 
     * The core component (e.g. the result repository) only adds a listener if
     * it doesn't already exists. Result is that the listener is added the first
     * time only.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test core component returned by factory is re-initialized on each
     * invocation.
     * 
     * The core component initializes is runtime directories from the pineapple
     * system property.
