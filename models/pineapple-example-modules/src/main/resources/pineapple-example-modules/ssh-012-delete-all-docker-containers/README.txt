...
Description
-------------
This example illustrates how the SSH plugin can be used to delete all Docker containers.
...
Intended operations
-----------------------
* "undeploy-configuration"  - will delete all container from the Docker daemon.

The model is targeted to the "undeploy-configuration" operation. All other operations is NOP.
