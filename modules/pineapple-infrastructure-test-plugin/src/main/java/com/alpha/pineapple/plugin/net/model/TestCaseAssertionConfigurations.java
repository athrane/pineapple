...
/**
 * Helper class which which contains predefined assertions for HTTP test cases.
 */
public class TestCaseAssertionConfigurations {
	...
	/**
	 * Initialize response properties for the HTTP redirect test case and store them
	 * in the command context.
	 * 
	 * @param context
	 *            Context where response properties are added to.
	 * @param redirecUrl
	...
	/**
	 * Initialize response properties for the HTTP header test case and store them
	 * in the command context.
	 * 
	 * @param context
	 *            Context where response properties are added to.
	 ...
	 * @param nonExistingHeaders
	 *            Non expected HTTP header.
	 */
	@SuppressWarnings("unchecked")
	void initializeHttpHeaderTestProperties(Context context, HashMap<String, String> headers,
			String[] nonExistingHeaders) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	void initializeHttpStickynessTestProperties(Context context, String environment, String host, String location,
			String[] servers) {
	...
	/**
	 * Initialize response properties for the HTTP load balancing test case and
	 ...
	 */
	@SuppressWarnings("unchecked")
	void initializeHttpLoadBalancingTestProperties(Context context, String environment, String host, String location,
			String[] servers) {
