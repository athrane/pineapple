...
public class StringUtils {
     ...
     * 
     * If the string representation of the object contains newline then the
     * string is abbreviated at the new line and "..." is appended. If the
     * object is null then null is returned.
     * 
     * @param targetObject
     ...
     * brackets.
     * 
     * If the string doesn't starts and ends with brackets then the original
     * string is returned.
     * 
     * @param source
     ...
     * If the string representation of the object contains newline then the
     * string is abbreviated at the new line and "..." is appended. If the
     * object is null then the string "null" is returned.
     * 
     * @param value
