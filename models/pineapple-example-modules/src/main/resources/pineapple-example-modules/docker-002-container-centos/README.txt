...
Description
-------------
This example illustrates how the Docker plugin can be used to create a Docker container from a CentOS image.
...
Intended operations
-----------------------
* "deploy-configuration"  - which will pull and create a Docker image and then create a container using the image.
