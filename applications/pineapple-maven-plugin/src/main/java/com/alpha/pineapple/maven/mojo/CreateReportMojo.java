...
/**
 * Goal which executes a Pineapple create-report operation on the Maven 
 ...
 * @goal create-report
 */
public class CreateReportMojo extends AbstractOperationMojo
{

    @Override
    public String getOperation()
    {
        return OperationNames.CREATE_REPORT;
    }
