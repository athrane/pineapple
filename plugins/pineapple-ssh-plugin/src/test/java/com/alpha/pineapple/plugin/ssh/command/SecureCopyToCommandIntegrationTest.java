...
public class SecureCopyToCommandIntegrationTest {
	...
	public void testCanCopySingleFileWithVariableSubstitution() throws Exception {
		...
		// setup mocks
		expect(coreVariableSubstitutionProvider.createSubstitutedFile(localFile, session, result))
				.andReturn(processedFile);
	...
	/**
	 * Test that command can copy a single file with variable substitution disabled.
	 * 
	 * @throws Exception
	 *             If test fails.
	 */
