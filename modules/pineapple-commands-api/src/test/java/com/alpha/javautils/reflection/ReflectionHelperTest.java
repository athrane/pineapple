...
public class ReflectionHelperTest
{
    ...
    /**
     * Test that instance creation fails class with no constructor which takes a single string as argument.
     */
    @Test( expected = InstantiationError.class )
     ...
     */
    @Test( expected = IllegalArgumentException.class )
    public void testInvokeSetterRejectsUndefinedTargetObject() throws SecurityException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException, Exception
    {
        // create helper
        helper = createReflectionHelper();
     ...
     */
    @Test( expected = IllegalArgumentException.class )
    public void testInvokeSetterRejectsUndefinedField() throws SecurityException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException, Exception
    {
        // create helper
        helper = createReflectionHelper();
     ...
     */
    @Test
    public void testInvokeSetterAcceptsUndefinedSetterParam() throws SecurityException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException, Exception
    {
        // create helper
        helper = createReflectionHelper();
     ...
     */
    @Test
    public void testInvokeSetterMethodInvokesCorrectMethod() throws SecurityException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException, Exception
    {
        // create helper
        helper = createReflectionHelper();
     ...
     */
    @Test( expected = IllegalArgumentException.class )
    public void testSetFieldValueRejectsUndefinedField() throws SecurityException, IllegalArgumentException, NoSuchMethodException, IllegalAccessException, Exception
    {
        // create helper
        helper = createReflectionHelper();
    ...
    /**
     * Test that helper set field value can set String array with zero elements 
     * on String[] field.
     * @throws Exception 
     */
    @Test
    ...
    /**
     * Test that helper set field value can set String array with one element 
     * on String[] field.
     * @throws Exception 
     */
    @Test
    ...
    /**
     * Test that helper set field value can set String array with two elements 
     * on String[] field.
     * @throws Exception 
     */
    @Test
    ...
    /**
     * Test that helper set field value can set String object which contains 
     * a comma separated list on String[] field.
     * @throws Exception 
     */
    @Test
    ...
    /**
     * Test that helper set field value method can set String value containing
     * a comma separated list on String field.
     * @throws Exception 
     */
    @Test
    ...
    /**
     * Test that set field value can set String object containing an
     * integer, e.g. "5" on int field.
     * @throws Exception 
     */
    @Test
    ...
    /**
     * Test that set field value method skips setting null value on primitive integer field.
     * @throws Exception 
     */
    @Test
