...
public class TestObjectIdentityCommandTest
{
    /**
     * Context.
     */
    ...
    public void setUp() throws Exception
    {
        ...
        // create command
        command = new TestObjectIdentityCommand();
    ...
    public void testSuccessfullyComparesTwoNullStrings()
    {
        try
        {
            ...
            resolvedType =  ResolvedTypeImpl.createResolvedObject( parent, pp, sp );
    ...
    @SuppressWarnings("unchecked")
	@Test
    public void testSuccceedsIfStringsAreDifferent()
    {
        try
        {
    		// complete execution result initialization
    ...
    /**
     * Test that two different booleans are compared correct.
     */
    @SuppressWarnings("unchecked")
	@Test
    public void testSucceedsIfBooleansAreDifferent()
    {
        try
        {
    		// complete execution result initialization
