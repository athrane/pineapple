...
public class TestHttpHeaderCommandIntegrationTest {
	...
	public void testFailsWithUnknownUrl() {
		try {
			...
			// create model
			mapper.mapHttpHeaderTest(test, context,
	...
	/**
	 * Test HTTP headers fails if host returns HTTP status code 404, although it
	 * also returns the expected headers.
	 */
	@SuppressWarnings("unchecked")
	@Test
	...
	/**
	 * Test that command succeeds with one header and no non present headers
	 * defined.
	 */
	@SuppressWarnings("unchecked")
	@Test
	...
	/**
	 * Test that command succeeds with no headers and no non present headers
	 * defined.
	 */
	@SuppressWarnings("unchecked")
	@Test
	...
	/**
	 * Test that command succeeds with two headers and no non present headers
	 * defined.
	 */
	@SuppressWarnings("unchecked")
	@Test
	...
	/**
	 * Test that command succeeds with zero expected headers and one non present
	 * headers defined.
	 */
	@SuppressWarnings("unchecked")
	@Test
	...
	/**
	 * Test that command fails with zero expected headers and one non present
	 * headers defined, but with the non present header returned from the server.
	 * 
	 */
	@SuppressWarnings("unchecked")
	@Test
	...
	/**
	 * Test that command fails with zero expected headers and two non present
	 * headers defined, but with the non present headers returned from the server.
	 * 
	 */
	@SuppressWarnings("unchecked")
	@Test
	...
	/**
	 * Test that command fails with one expected headers and one non present headers
	 * defined, but with the non present header returned from the server.
	 * 
	 */
	@SuppressWarnings("unchecked")
	@Test
	...
	/**
	 * Test that command fails with one expected headers and one non present headers
	 * defined, where they share the same/value and the header is returned from the
	 * server
	 * 
	 */
	@SuppressWarnings("unchecked")
