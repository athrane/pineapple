...
public class CompositeVariablesBuilderImplIntegrationTest {
	...
	/**
	 * Test that variables construction succeeds with one empty builder registered.
	 * 
	 * @throws Exception
	 *             if test fails.
	 */
	...
	/**
	 * Test that variables construction succeeds with two empty builders registered.
	 * 
	 * @throws Exception
	 *             if test fails.
	 */
	...
	/**
	 * Test that variables construction succeeds with one builder registered. With
	...
	/**
	 * Test that variables construction succeeds with two builders registered. With
	 * one (different) variable defined in each.
	 * 
	 * @throws Exception
	 *             if test fails.
	 */
	...
	/**
	 * Test that variables construction succeeds with two builders registered. With
	 * one identical variable (identical key and value) defined in each.
	 * 
	 * @throws Exception
	 *             if test fails.
	 */
	...
	/**
	 * Test that variables construction succeeds with two builders registered. With
	 * one identical variable (identical key but different value) defined in each.
	 * 
	 * @throws Exception
	 *             if test fails.
	 */
	 ...
	 * With one identical variable (identical key but different value) defined in
	 * each.
	 * 
	 * @throws Exception
	 *             if test fails.
