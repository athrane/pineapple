...
public class CreateDefaulConfigurationCommandIntegrationTest {
    ...
    /**
     * Test that files are create if none exists and even if all directories
     * doesn't exist
     * 
     * @throws Exception
     *             If test fails.
    ...
    /**
     * Test created resources configuration contains expected number
     * environments.
     * 
     * @throws Exception
     *             If test fails.
    ...
    /**
     * Test created credentials configuration contains expected number
     * environments. *
     * 
     * @throws Exception
     *             If test fails.
