...
public class ObjectMotherModule {
	 ...
	 * Create a module model object, with a single aggregated model.
	 * 
	 * The aggregated model contain a trigger definition. The aggregated model is
	 * decorated with the target-resource attribute.
	 * 
	 * @param targetResource
	 *            Value of the target-resource attribute.
	 ...
	 * 
	 * @param triggerOnResult
	 *            trigger result directive.
	 * @param triggerOnOperation
	 *            trigger operation directive public @param aggregatedModel
	 *            aggregated to which the trigger is added.
	 */
