...
public class InvokePluginsCommand implements Command {
    ...
    /**
     * Key used to identify property in context: Contains load module
     * descriptor.
     */
    public static final String MODULE_KEY = CoreConstants.MODULE_KEY;

    /**
     * Key used to identify property in context: Contains loaded Pineapple
     * module model.
     */
    ...
    /**
     * Set the continue-on-failure directive on the root result continuation
     * policy.
     * 
     * @param rootResult
     ...
     * @param result
     *            execution result. The execution result for the execution of
     *            the triggers are added as a child result.
     */
