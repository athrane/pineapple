...
public class ExecutionPanel {
    ...
    /**
     * Generate details for selected execution result tree item. Creates a list
     * box model with messages from the execution result backing the selected
     * tree node.
     */
    @Command
     ...
     * {@linkplain ResultNotificationNotifierImpl} which posts the global
     * command.
     * 
    ...
    /**
     * Lookup execution info execution controller using the execution ID from
     * the session state.
     * 
     * If the execution ID can't be resolved to an execution info then null is
     * returned.
     * 
     * @return execution info from execution ID. If the execution info isn't
     ...
     * 
     * The event handler will start the asynchronous execution of an operation 
     * and then notify the MVVM binder that the tree is updated.
     * 
     * @param operation
     ...
     * triggered from the "Execute Last" button on the execution panel which
     * posts the command.
     * 
     * The event handler will post the global command to trigger execution of
     * the operation in the execution panel controller.
     */
    @Command
    ...
    /**
     * Event handler for the command "executeTestOperation". The event is
     * triggered from the "Execute" button on the execution panel which posts
     * the command.
     * 
     * The event handler will post the global command to trigger execution of
     * the operation in the execution panel controller.
    ...
    /**
     * Event handler for the command "executeUndeployConfigurationOperation".
     * The event is triggered from the "Execute" button on the execution panel
     * which posts the command.
     * 
     * The event handler will post the global command to trigger execution of
     * the operation in the execution panel controller.
     */
    ...
    /**
     * Event handler for the command "executeCreateReportOperation". The event
     * is triggered from the "Execute" button on the execution panel which posts
     * the command.
     * 
     * The event handler will post the global command to trigger execution of
     * the operation in the execution panel controller.
    ...
    /**
     * Event handler for the command "cancelOperation". The event is triggered
     * from the "Cancel Operation" button on the execution panel which posts the
     * command.
     * 
     * The event handler will post the global command to trigger execution of
     * the operation in the execution panel controller.
    ...
    /**
     * Return true if execution is starting, i.e. the root result signals that
     * it is running.
     * 
     * @param notification
