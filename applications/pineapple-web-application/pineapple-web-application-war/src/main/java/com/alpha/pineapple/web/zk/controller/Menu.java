...
public class Menu extends SelectorComposer<Component> {
	 ...
	 * 
	 * Post global command to trigger model creation in the module panel view model.
	 * 
	 ...
	 * 
	 * Post global command to trigger download the model into the browser from the
	 * module panel view model.
	 * 
	 * Global command has to be posted "manually" in this event handler since
	 * composer can't trigger global commands in .ZUL page.
	 * 
	 ...
	 * 
	 * Post global command to trigger model deletion of the selected model in the
	 * module panel view model. Global command has to be posted "manually" in this
	...
	/**
	 * Event handler for the onClick event for the "Deploy Configuration" menu item.
	 * 
	 * @param evt
	 *            Event object.
	 */
	...
	/**
	 * Event handler for the onClick event for the "Deploy Application" menu item.
	 * 
	 * @param evt
	 *            Event object.
	 */
	...
	/**
	 * Event handler for the onClick event for the "Start Application" menu item.
	 * 
	 * @param evt
	 *            Event object.
	 */
	...
	/**
	 * Event handler for the onClick event for the "Undeploy Application" menu item.
	 * 
	 * @param evt
	 *            Event object.
	 */
	...
	/**
	 * Event handler for the onClick event for the "Create Scheduled Operation" menu
	 * item.
	 * 
	 * Post global command to trigger scheduled operation creation in the scheduled
	 * operation panel view model.
	 * 
	 * Global command has to be posted "manually" in this event handler since
	 * composer can't trigger global commands in .ZUL page.
	 * 
	...
	/**
	 * Event handler for the onClick event for the "Delete Scheduled Operation" menu
	 * item.
	 * 
	 * Post global command to trigger scheduled operation deletion in the scheduled
	 * operation panel view model.
	 * 
	 * Global command has to be posted "manually" in this event handler since
	 * composer can't trigger global commands in .ZUL page.
	 ...
	 * model. Global command has to be posted "manually" in this event handler since
	 * composer can't trigger global commands in .ZUL page.
	 * 
	 * @param evt
	 *            Event object.
	...
	/**
	 * Event handler for the onClick event for the "Delete all reports" menu item.
	 * 
	 * Post global command to trigger deletion of all reports in the report panel
	 * view model. Global command has to be posted "manually" in this event handler
	...
	/**
	 * Event handler for the onClick event for the "Create Credential" menu item.
	 * 
	 * @param evt
	 *            Event object.
	 */
	...
	/**
	 * Event handler for the onClick event for the "Delete Credential" menu item.
	 * 
	 * @param evt
	 *            Event object.
	 */
	...
	/**
	 * Event handler for the onClick event for the "Create Environment" menu item.
	 * 
	 * @param evt
	 *            Event object.
	 */
	...
	/**
	 * Event handler for the onClick event for the "Delete Environment" menu item.
	 * 
	 * @param evt
	 *            Event object.
	 */
	...
	/**
	 * Event handler for the onClick event for the "Refresh Environment
	...
	/**
	 * Event handler for the onClick event for the "Enable debug info" menu item.
	 * 
	 * @param evt
	 *            Event object.
	 */
