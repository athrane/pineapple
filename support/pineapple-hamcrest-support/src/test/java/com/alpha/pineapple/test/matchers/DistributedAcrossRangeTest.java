...
public class DistributedAcrossRangeTest {
	...
	/**
	 * Test that matcher succeeds with range of one value and two values in matched
	 * collection with is defined in range.
	 */
	@Test
	...
	/**
	 * Test that matcher succeeds with range of one value and five values in matched
	 * collection with is defined in range.
	 */
	@Test
	...
	/**
	 * Test that matcher succeeds with range of two value and one value in matched
	 * collection with is defined in range.
	 */
	@Test
	...
	/**
	 * Test that matcher succeeds with range of two values and one value in matched
	 * collection with is defined in range and distributed evenly.
	 */
	@Test
	...
	/**
	 * Test that matcher succeeds with range of two values and three value in
	 * matched collection with is defined in range and distributed evenly.
	 */
	@Test
	...
	/**
	 * Test that matcher succeeds with range of two values and four values in
	 * matched collection with is defined in range and distributed evenly.
	 */
	@Test
	...
	/**
	 * Test that matcher succeeds with range of two values and five values in
	 * matched collection with is defined in range and distributed evenly.
	 */
	@Test
	...
	/**
	 * Test that matcher succeeds with range of three values and 12 values in
	 * matched collection with is defined in range and distributed evenly.
	 */
	@Test
	public void testSucceedsWithRangeOfThreeAndTwelveValueswhichIsDistributedEvenly() {
		...
		// create actual values
		String[] actualValues = new String[] { "item2", "item1", "item2", "item1", "item2", "item1", "item2", "item3",
	...
	/**
	 * Test that matcher succeeds with range of three values and 15 values in
	 * matched collection with is defined in range and distributed evenly.
	 */
	@Test
	public void testSucceedsWithRangeOfThreeAndFourteenValueswhichIsDistributedEvenly() {
		...
		// create actual values
		String[] actualValues = new String[] { "item2", "item1", "item3", "item2", "item1", "item3", "item2", "item1",
				"item3", "item2", "item1", "item3", "item1", "item2" };
	...
	/**
	 * Test that matcher fails with range of two value and three identical values in
	...
	/**
	 * Test that matcher fails with range of one value and one empty ("") value in
	 * matched collection.
	 */
	@Test
	...
	/**
	 * Test that matcher fails with range of one value and two empty ("") values in
	 * matched collection.
	 */
	@Test
	...
	/**
	 * Test that matcher fails with range of one value and one null value in matched
	 * collection.
	 */
	@Test
