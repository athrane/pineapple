...
public class FileBasedCredentialProviderIntegrationTest {
    ...
    /**
     * Provider can be initialized with configuration with multiple
     * environments.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Get credential method throws exception if environment is unknown.
    ...
    /**
     * Get credential method can look up credential in environment. Environment
    ...
    /**
     * Contains credential method throws exception if id is unknown in
     * environment. Environment is defined, with no resource.
     */
    @Test
    ...
    /**
     * Contains credential method can look up credential in environment.
     * Environment is defined, credential is defined.
     * 
     * @throws Exception
     *             if test fails.
     */
     ...
     * doesn't contains any credentials.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Credential provider returns different credential instance on each
     * invocation.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Provider can update credential. Updated credential info has different
     * hash code.
     * 
     * @throws Exception
     *             if test fails.
