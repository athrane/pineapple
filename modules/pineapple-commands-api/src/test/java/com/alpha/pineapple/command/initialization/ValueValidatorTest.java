...
public class ValueValidatorTest
{
    ...
    /**
     * Test field used to testing.
     * Field contains no annotation.
     */
    String notAnnotatedField;

    /**
     * Test field used to testing.
     * Field contains annotation with no values defined.
     */
    @ValidateValue({})
    ...
    /**
     * Test field used to testing.
     * Field contains annotation with not null policy defined.
     */
    ...
    /**
     * Test field used to testing.
     * String field contains annotation with not empty policy defined.
     */
    ...
    /**
     * Test field used to testing.
     * Map field contains annotation with not empty policy defined.
     */
    @ValidateValue({ValidationPolicy.NOT_EMPTY})
    ...
    /**
     * Test field used to testing.
     * Collection field contains annotation with not empty policy defined.
     */
    @ValidateValue({ValidationPolicy.NOT_EMPTY})
    ...
    /**
     * Test field used to testing.
     * Object array field contains annotation with not empty policy defined.
     */
    @ValidateValue({ValidationPolicy.NOT_EMPTY})
    ...
    /**
     * Test field used to testing.
     * ArrayList field contains annotation with not empty policy defined.
     */
    @ValidateValue({ValidationPolicy.NOT_EMPTY})
    ...
    /**
     * Test field used to testing.
     * File field contains annotation with not empty policy defined.
     */
    @ValidateValue({ValidationPolicy.NOT_EMPTY})
    ...
    /**
     * Test that validator can validate field with annotation defined which
     * contains an empty value set.
     * 
     */
    @Test
    ...
    /**
     * Test that validator can validate field with annotation defined which 
     * contains an {@link ValidationPolicy.NOT_NULL} policy defined.
     * 
     */
    @Test
    ...
    /**
     * Test that validation of {@link ValidationPolicy.NOT_NULL} policy fails
     * if field value is null.
     * @throws CommandInitializationFailedException If validation fails.
     * 
     */
    ...
    /**
     * Test that validation of {@link ValidationPolicy.NOT_EMPTY} policy fails
    ...
    /**
     * Test that validation of {@link ValidationPolicy.NOT_EMPTY} policy fails
     * if field value is empty collection.
     * 
     * @throws CommandInitializationFailedException If validation fails.      
     */
    @Test( expected = CommandInitializationFailedException.class )
    public void testNotEmptyPolicyValidationFailsIfCollectionFieldIsEmpty() throws CommandInitializationFailedException
    {
        try
        {
            // create initializer
    ...
    /**
     * Test that validation of {@link ValidationPolicy.NOT_EMPTY} policy fails
     * if field value is empty object array.
     * 
     * @throws CommandInitializationFailedException If validation fails.      
     */
    @Test( expected = CommandInitializationFailedException.class )
    public void testNotEmptyPolicyValidationFailsIfObjectArrayFieldIsEmpty() throws CommandInitializationFailedException
    {
        try
        {
            // create initializer
    ...
    /**
     * Test that validation of {@link ValidationPolicy.NOT_EMPTY} policy fails
     * if field value is empty ArrayList.
     * 
     * @throws CommandInitializationFailedException If validation fails.      
     */
    @Test( expected = CommandInitializationFailedException.class )
     ...
     */
    @Test( expected = CommandInitializationFailedException.class )
    public void testNotEmptyPolicyValidationFailsIfStringArrayFieldIsNull() throws CommandInitializationFailedException
    {
        try
        {
            // create initializer
    ...
    /**
     * Test that validation of {@link ValidationPolicy.NOT_EMPTY} policy 
     * fails if is string array contains zero elements.
     * 
     * @throws CommandInitializationFailedException If validation fails.      
     */
    @Test( expected = CommandInitializationFailedException.class )
    public void testNotEmptyPolicyValidationFailsIfStringArrayFieldContainsZeroElements() throws CommandInitializationFailedException
    {
        try
        {
            // create initializer
    ...
    /**
     * Test that validation of {@link ValidationPolicy.NOT_EMPTY} policy 
     * succeeds if is string array contains one element.
     * 
     * @throws CommandInitializationFailedException If validation fails.      
     */
    @Test
    public void testNotEmptyPolicyValidationSucceedsIfStringArrayFieldContainsOneElement() throws CommandInitializationFailedException
    {
        try
        {
            // create initializer
    ...
    /**
     * Test that validation of {@link ValidationPolicy.NOT_EMPTY} policy 
     * succeeds if is string array contains two elements.
     * 
     * @throws CommandInitializationFailedException If validation fails.      
     */
    @Test
    public void testNotEmptyPolicyValidationSucceedsIfStringArrayFieldContainsTwoElements() throws CommandInitializationFailedException
    {
        try
        {
            // create initializer
    ...
    /**
     * Test validation of {@link File} field with 
     * {@link ValidationPolicy.NOT_EMPTY} policy defined.
     */
    @Test
    ...
    /**
     * Test that validation of {@link ValidationPolicy.NOT_EMPTY} policy fails
     * if field value contains empty file name, i.e. "".
     * 
     * @throws CommandInitializationFailedException If validation fails.      
     */
    @Test( expected = CommandInitializationFailedException.class )
    ...
    /**
     * Test that validation of {@link ValidationPolicy.NOT_EMPTY} policy 
     * succeeds if parent is empty and child is defined.
     * 
     * @throws CommandInitializationFailedException If validation fails.      
     */
    @Test
    public void testNotEmptyPolicyValidationSucceedsIfFileFieldContainsEmptyParentAndDefinedChild() throws CommandInitializationFailedException
    {
        try
        {
            // create initializer
    ...
    /**
     * Test that validation of {@link ValidationPolicy.NOT_EMPTY} policy 
     * succeeds if parent is defined and empty child.
     * 
     * @throws CommandInitializationFailedException If validation fails.      
     */
    @Test
    public void testNotEmptyPolicyValidationSucceedsIfFileFieldContainsDefinedParentAndEmptyChild() throws CommandInitializationFailedException
    {
        try
        {
            // create initializer
