...
/**
 * Unit test for {@linkplain Release9ArgumentBuilder} class.
 */
public class Release9ArgumentBuilderTest {

	/**
	 * Object under test.
	 */
	Release9ArgumentBuilder argumentBuilder;
	...
	public void setUp() throws Exception {
		...
		argumentBuilder  = new Release9ArgumentBuilder();				
	}
	...
	public void testAddUninstallationSilentModeArgument() {
		...
		// test 
		assertEquals(1,arguments.length);
		assertEquals("-silent",arguments[0]);
	}
