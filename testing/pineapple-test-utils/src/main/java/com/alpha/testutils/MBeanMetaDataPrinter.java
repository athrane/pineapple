...
public class MBeanMetaDataPrinter {
	...
	/**
	 * Print MBean interfaces implemented by the MBean. An interface is identified
	 * as an MBean interface is has the name *MBean.
	 * 
	 * @param objectName
	 ...
	 * criteria which decides if an interface is an MBean interface is whether the
	 * interface contains the String MBean in the interface name.
	 * 
	 * @param objectName
