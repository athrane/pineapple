...
public class CoreIntegrationTest {
     ...
     * it will return the same core instance when the factory method is invoked
     * as returned by the spring context.
     * 
     * The Pineapple home system property is set to use the test directory.
     * 
     * The credential provider will write the credentials to the Pineapple home
     * set by the system variable.
     * 
     ...
     * 
     * If the factory is created with its dependencies injected by Spring, then
     * it will return the same core instance when invoked multiple times, e.g.
     ...
     * {@link CoreFactory} and that it is successfully initialized.
     * 
     * The Pineapple home system property is set to use the test directory.
     * 
     * Initialization FAILS since the plugins defined in the default
     * configuration isn't available on the class path.
     * 
    ...
    /**
     * Factory test, i.e. that core instance can be created from
     * {@link CoreFactory} and that is it contains four child results
     * (initialize home dir, create default configuration, load resource
     * configuration and initialize plugin activator) since "initialize
     * scheduled operations" is skipped when the plugin initialization fails.
     * 
     * The Pineapple home system property is set to use the test directory.
     * 
     * Initialization FAILS since the plugins defined in the default
    ...
    /**
     * Factory test, i.e. that core instance can be created from
     * {@link CoreFactory} and that is it contains three child results (load
     * resource configuration, initialize plugin activator and initialize
     * scheduled operations) since "initialize home dir" and
     * "create default configuration" are skipped.
     * 
     * The Pineapple home system property is set to use the test directory.
     * 
     * The credential provider will write the credentials to the Pineapple home
    ...
    /**
     * Initialization test. Tests that core instance can be created with
     * external resources file. The file is specified by an absolute file name.
     * 
     * The Pineapple home system property is set to use the test directory.
     * 
     * The credential provider will write the credentials to the Pineapple home
    ...
    /**
     * Initialization test. Tests that core instance can be created with
     * external resources file, which isn't named "resources.xml". The resources
    ...
    /**
     * Initialization test, tests that core instance can be created with
     * internal resources file, with a named resources file, f.x.
     * "resources.xml". The test case will attempt to load the file from the
     * class path which contains src/test/resources/resources.xml.
     * 
     * The Pineapple home system property is set to use the test directory.
     * 
     * The credential provider will write the credentials to the Pineapple home
    ...
    /**
     * Test module repository in core component is updated when core component
     * is re-initialized.
     * 
     * The core component is re-initialized with one module and then
     * re-initialized with a second module added.
     * 
     * @throws Exception
     *             if test fails.
     */
