...
public interface ResourceRepository {
	...
	/**
	 * Get resource info with id and environment. If the no module exists with the
	 ...
	 *            credential ID reference. Can be null or empty if no reference is
	 *            defined.
	 * 
	 * @throws EnvironmentNotFoundException
	...
	/**
	 * Get plugin id's for all registered resources in all environments. A plugin id
	 * is only returned once despite being used by several resources.
	 * 
