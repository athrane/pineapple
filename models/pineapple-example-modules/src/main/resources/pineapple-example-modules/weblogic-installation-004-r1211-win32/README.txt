...
Description
-------------
This example illustrates how to install WebLogic 12.1.1 on 32-bit Windows.
...
-----------------------
Download the WebLogic installer named "wls1211_win32.exe" and place it in the "bin" directory.
