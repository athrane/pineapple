...
public interface ModuleRepository {
	...
	/**
	 * Get module info with queried id. If the no module exists with the id then a
	 * <code>ModuleNotFoundException</code> is thrown.
	 * 
	 * @param id
	 *            ID of the module to search for.
	 * 
	 * @return module info with with queried id. If the no module exists with the id
	 *         then a <code>ModuleNotFoundException</code> is thrown.
	 * 
	...
	/**
	 * Resolve module info with id and environment. If the no module exists with the
	 * id and a module model for the requested environment then a
	 * <code>ModuleNotFoundException</code> is thrown.
	 * 
	 * @param id
	 *            Id of the module to search for.
	 ...
	 * 
	 * @return module info. If the no module exists with the id and a module model
	 *         for the requested environment then a
	 *         <code>ModuleNotFoundException</code> is thrown.
	 * 
	 * @throws ModuleNotFoundException
	 *             if requested module info isn't defined in the repository.
	 * @throws ModelNotFoundException
	 *             if requested module info doesn't contain requested environment.
	 */
