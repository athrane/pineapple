...
public class ObjectMotherIO {
     ...
     * @param testMethodName
     *            Name of the test method.
     * @return File object defining the local test method directory. The name of
     *         the test method directory is
    ...
    /**
     * Deletes all files and sub directories under directory. Returns true if
