...
public class ObjectMotherEnvironmentConfiguration {
     ...
     * @param targetPackage
     *            Defines the Java package which contains the JAXB generated
     *            classes which should be use to unmarshall the XML file into.
     * 
    ...
    /**
     * Create empty environment configuration object, i.e. with no environment
     * or credentials.
     * 
    ...
    /**
     * Create environment configuration with a single credential. The
     * credentials are named "credential-1" and "credential-2" in environment
     * "environment-1".
     * 
    ...
    /**
     * Create environment configuration with a single credential. The credential
     * is name "credential-1" in environment "environment-1".
     * 
     * @return environment configuration with a single credential.
     */
    ...
    /**
     * Create environment configuration with a single credential in an
     * environment.
     *
     * @param environmentId
     *            environment ID.
     ...
     *            password.
     * 
     * @return environment configuration with a single credential in an
     *         environment.
     */
     ...
     *            password.
     * 
     * @return environment configuration with a single encrypted credential in
     *         an environment.
     */
    ...
    /**
     * Create environment configuration with a single credential. The credential
     * is name "test-resource-credentialidentifier" in environment
     * "environment-1".
     * 
     * @return environment configuration with a single credential.
     */
     ...
     * named "test-resource-resource-id" in environment "environment-1" and have
     * a single property.
     * 
     * @return environment configuration with a single credential.
     */
    ...
    /**
     * Create environment configuration with a single resource in an
     * environment.
     *
     * @param environmentId
     *            environment ID.
     ...
     * 
     * @return environment configuration with a single resource in an
     *         environment.
     */
    ...
    /**
     * Create environment configuration with a single resource in an
     * environment. The plugin id of the added resource will be random
     * geenrated.
     *
     * @param environmentId
     *            environment ID.
    ...
    /**
     * Create reports object with one report with zero duration and defined to
     * be scheduled.
     * 
     * @param value
