...
public class PasswordEncryptingCredentialConfigurationMarshallerImplIntegrationTest {
    ...
    /**
     * Test that credential configuration with one environment with no
     * credential can be mapped.
     * 
    ...
    /**
     * Test that credential configuration with one environment with one
     * credential can be mapped.
     * 
     * The credential password isn't encrypted initially in the configuration.
     * The marshaller will encrypt the password and append the "encrypted:"
     * prefix.
     */
    @Test
     ...
     * 
     * The credential password is encrypted initially in the configuration. The
     * marshaller will map the encrypted password. The configuration isn't
     * updated (e.g. saved) since the state isn't changed.
     */
    @Test
     ...
     * 
     * The credential password isn't encrypted initially in the configuration,
     * even though the password is prefixed with the "encrypted:" prefix.
     * 
     * The marshaller will encrypt the password and append the "encrypted:"
     * prefix.
     */
     ...
     * 
     * The marshaller will encrypt the password and append the "encrypted:"
     * prefix. The configuration is updated (e.g. saved) with the encrypted
     * credential.
     */
    @Test
