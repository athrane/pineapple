...
/**
 * Goal which executes a Pineapple deploy-configuration operation on the Maven 
 ...
 * @goal deploy-config 
 */
public class DeployConfigurationMojo extends AbstractOperationMojo
{

    @Override
    public String getOperation()
    {
        return OperationNames.DEPLOY_CONFIGURATION;
    }
