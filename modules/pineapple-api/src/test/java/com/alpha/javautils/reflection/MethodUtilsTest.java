...
public class MethodUtilsTest {
	...
	/**
	 * Test classIsDeclaredInPackages method fails if class isn't declared in any of
	...
	/**
	 * Test classIsDeclaredInPackages succeeds if class is declared in one of the
	 * supplied packages.
	 */
	@Test
	...
	/**
	 * Test classIsDeclaredInPackages fails if class isn't declared in one of the
	 * supplied packages.
	 */
	@Test
	...
	/**
	 * Test methodNameStartsWithGet fails if method starts with 'Get', ie. Capital
	 * 'G'.
	 * 
	 * @throws Exception
	 *             if test fails.
	...
	/**
	 * Test methodReturnsPrimitiveBoolean fails if method doesn't return a primitive
	 * boolean.
	 * 
	 * @throws Exception
	 *             if test fails.
	...
	/**
	 * test resolveGetterMethods method returns empty method array if attribute name
	 * is empty string.
	 */
	@Test
	...
	/**
	 * test resolveGetterMethods method returns empty method array if matcher match
	 * any methods on a simple type but with an attribute name which isn't defined
	 * on the object.
	 */
	@Test
	...
	/**
	 * test resolveGetterMethods method returns empty method array if matcher match
	 * any methods on a simple type but with an attribute name which is defined on
	 * the object, in this case 'hashcode' is used as attribute name.
	 */
	@Test
