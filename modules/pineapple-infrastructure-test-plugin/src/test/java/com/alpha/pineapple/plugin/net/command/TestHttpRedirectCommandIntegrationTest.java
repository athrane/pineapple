...
public class TestHttpRedirectCommandIntegrationTest {
	...
	public void testFailsWithUnknownUrl() {
		try {
			...
			// create model
			mapper.mapHttpRedirectTest(test, context,
	...
	/**
	 * Test that command succeeds with an URL which is redirected with 301 and a
	 * "Location" header.
	 */
	@SuppressWarnings("unchecked")
	@Test
	...
	/**
	 * Test that command succeeds with an URL which is redirected with 302 and a
	 * "Location" header.
	 */
	@SuppressWarnings("unchecked")
	@Test
	...
	/**
	 * Test that command succeeds with an URL which is redirected with 303 and a
	 * "Location" header.
	 */
	@SuppressWarnings("unchecked")
	@Test
	public void testSucceedsRedirectedUrlWithStatus303() {
		try {
			// create HTTP server
			httpServer = httpServerMother.createHttpServerWithRedirect303(httpServerMother.getHostIPAddress(true),
					HTTP_PORT);
	...
	/**
	 * Test that command succeeds with an URL which is redirected with 304 and a
	 * "Location" header.
	 */
	@SuppressWarnings("unchecked")
	@Test
	public void testSucceedsRedirectedUrlWithStatus304() {
		try {
			// create HTTP server
			httpServer = httpServerMother.createHttpServerWithRedirect304(httpServerMother.getHostIPAddress(true),
					HTTP_PORT);
	...
	/**
	 * Test that command succeeds with an URL which is redirected with 305 and a
	 * "Location" header.
	 */
	@SuppressWarnings("unchecked")
	@Test
	public void testSucceedsRedirectedUrlWithStatus305() {
		try {
			// create HTTP server
			httpServer = httpServerMother.createHttpServerWithRedirect305(httpServerMother.getHostIPAddress(true),
					HTTP_PORT);
	...
	/**
	 * Test that command fails with an URL which is redirected with 306 and a
	 * "Location" header.
	 */
	@SuppressWarnings("unchecked")
	@Test
	public void testFailsRedirectedUrlWithStatus306() {
		try {
			// create HTTP server
			httpServer = httpServerMother.createHttpServerWithRedirect306(httpServerMother.getHostIPAddress(true),
					HTTP_PORT);
	...
	/**
	 * Test that command fails if the server returns 200 and no "Location" header is
	 * defined.
	 */
	@SuppressWarnings("unchecked")
	@Test
