 ...
 * unit testing agent sessions.
 * 
 * Please notice that this class mirrors the dependencies of the
 * {@linkplain AgentSessionImpl} class since it inject all dependencies into the
 * session class.
 */
public class ObjectMotherAgentSession {
	 ...
	 * 
	 * @param host
	 *            agent host used to establish connection.
	 * @param port
	 *            TCP port where connection is established.
	 * 
	 * @return connected agent session.
	 */
	public AgentSession createConnectedSshSessionWithPasswordAuthentication(String host, int port, String user,
			String password) {
