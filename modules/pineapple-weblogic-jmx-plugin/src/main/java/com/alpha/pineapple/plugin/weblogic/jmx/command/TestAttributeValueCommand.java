...
/**
 * <p>
 * Implementation of the <code>Implementation of the <code>org.apache.commons.chain.Command</code> interface which 
 ...
 * </p>        
 */
public class TestAttributeValueCommand implements Command
{
    /**
    ...
    public boolean execute( Context context ) throws Exception
    {
        ...
        {
        	logger.debug( messageProvider.getMessage("tavc.start"));        	
        }
        ...
        if ( logger.isDebugEnabled() ) 
        {
        	logger.debug( messageProvider.getMessage("tavc.completed"));        	
        }
    ...
    void doTest( Context context ) throws Exception
    {
        ...
        if (!resolvedType.getPrimaryParticipant().isResolutionSuccesful() ) {
        	...
        	executionResult.completeAsFailure(messageProvider, "tavc.primary_resolution_failed", args);
            return;
        }
        ...
        if (!resolvedType.getSecondaryParticiant().isResolutionSuccesful() ) {
        	...
        	executionResult.completeAsFailure(messageProvider, "tavc.secondary_resolution_failed", args);
            return;
        }
        ...
        if ( value1 == null) {
            if (value2 == null) {
            	...
            	executionResult.completeAsSuccessful(messageProvider, "tavc.null_succeed");
                return;            	
            }
        	...
        	executionResult.completeAsFailure(messageProvider, "tavc.not_equal_failed", args);
            return;        	        	        	        	
        }
        ...
        if ( value1.equals( value2 )) {
    		...
    		Object[] args = { resolvedType.getPrimaryParticipant().getValueAsSingleLineString(), 
    				resolvedType.getSecondaryParticiant().getValueAsSingleLineString() };    		
        	executionResult.completeAsSuccessful(messageProvider, "tavc.succeed", args);        	
            return;
        } else {
