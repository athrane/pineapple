...
Description
-------------
This example illustrates how the SSH plugin can be used to start a Docker host.
This module is from the module named infrastructure-test-005-monitor-docker-host
as as example of how to use triggers.
