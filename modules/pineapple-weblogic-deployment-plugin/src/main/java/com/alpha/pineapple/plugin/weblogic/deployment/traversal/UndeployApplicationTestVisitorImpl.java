...
import com.alpha.pineapple.jsr88.command.TestModuleIsNotDeployedCommand;
...
/**
 * Visitor which implements an undeploy-application-test management operation.
 */
public class UndeployApplicationTestVisitorImpl
{
    /**
     * Catalog name for JSR-88 commands.
     */
    static final String CATALOG = "com.alpha.pineapple.jsr88.command";
    ...
    /**
     * UndeployApplicationTestVisitorImpl constructor.
     * 
     * @param context
     ...
     * @throws Exception 
     */
    public UndeployApplicationTestVisitorImpl( Context context, Session session ) throws Exception
    {
     ...
     * @param session
     *            Session which the visitor should access.
     * @throws Exception If visitor creation fails. 
     */
    public UndeployApplicationTestVisitorImpl( FileLocator fileLocator, Context context, Session session ) throws Exception
    {
        super();
    ...
    public void visitResourceAfterChildren( ConfigurationNode node ) throws Exception
    {
        ...
        // setup context
        testContext.put( TestModuleIsNotDeployedCommand.DESCRIPTION_KEY, identifier );
        testContext.put( TestModuleIsNotDeployedCommand.MANAGER_KEY, manager );
        testContext.put( TestModuleIsNotDeployedCommand.MODULE_KEY, identifier );
        testContext.put( TestModuleIsNotDeployedCommand.TARGETS_KEY, targets );

        // execute test
        runner.run( CommandNames.MODULE_ISNT_DEPLOYED, testContext );
