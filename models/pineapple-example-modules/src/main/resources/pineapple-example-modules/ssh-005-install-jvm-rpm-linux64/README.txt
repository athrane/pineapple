...
a 64 bit Java Virtual Machine(JVM) in Linux from a RPM package.  
...
Download the Java SE distribution jdk-7u25-linux-x64.rpm and place it in the /bin directory.
