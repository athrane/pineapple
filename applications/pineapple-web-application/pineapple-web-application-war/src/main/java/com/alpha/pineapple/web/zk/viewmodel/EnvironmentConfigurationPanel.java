...
public class EnvironmentConfigurationPanel {
    ...
    /**
     * Null model environment. Created in the init() method, can't be constant
     * since object factory is injected.
     */
    Environment nullEnvironment = null;

    /**
     * Null model resource. Created in the init() method, can't be constant
     * since object factory is injected.
     */
    Resource nullResource = null;

    /**
     * Null model resource property. Created in the init() method, can't be
     * constant since object factory is injected.
     */
    ResourceProperty nullResourceProperty = null;

    /**
     * Null model credential. Created in the init() method, can't be constant
     * since object factory is injected.
     */
     ...
     *         "NewResource" if a new resource is under creation.
     *         "NewCredential" if a new credential is under creation.
     *         "Environment" if a environment is selected an should rendered.
     *         "Resource" if a resource is selected an should rendered.
     *         "Credential" if a credential is selected an should rendered.
     *         "NothingSelected" if nothing is selected. Textual representation
     *         of the state.
     */
    ...
    /**
     * Returns the value of confirm environment deletion flag. If the flag is
     * true then the environment deletion modal windows is enabled.
     * 
    ...
    /**
     * Returns the value of confirm resource deletion flag. If the flag is true
     * then the resource deletion modal windows is enabled.
     * 
    ...
    /**
     * Returns the value of confirm resource property deletion flag. If the flag
     * is true then the resource property deletion modal windows is enabled.
     * 
    ...
    /**
     * Returns the value of confirm credential deletion flag. If the flag is
     * true then the credential deletion modal windows is enabled.
     * 
     ...
     * 
     * Step 2) of creating a the new environment. Will save temporary
     * environment in core component using REST API and update the model.
     */
    @Command
     ...
     * triggered from the menu controller and the environment configuration
     * panel which posts the global command.
     * 
     * Step 1) of deleting a environment. Will show deletion confirmation
     * dialog.
     */
    @GlobalCommand
     ...
     * 
     * Step 2) of deleting a environment. Will close the modal window and delete
     * the environment.
     */
    @Command
    ...
    /**
     * Event handler for the global command "createResource". The event is
     * triggered from the menu controller which posts the global command.
     * 
     * Step 1) of creating a the new resource. Will create a new temporary
     * resource for editing and saving.
     */
    @GlobalCommand
    ...
    /**
     * Event handler for the global command "deleteResource". The event is
     * triggered from the menu controller and the environment configuration
     * panel which posts the global command.
     * 
     ...
     * triggered from the confirm deletion modal window.
     * 
     * Step 2) of deleting a resource. Will close the modal window and delete
     * the resource.
     */
    @Command
     ...
     * 
     * Will update selected and possibly modified resource in core component
     * using REST API and update the model.
     */
    @Command
    @NotifyChange({ "pageState", "treeModel" })
     ...
     * 
     * Step 2) of creating a the new credential. Will save temporary credential
     * in core component using REST API and update the model.
     */
    @Command
     ...
     * triggered from the confirm deletion modal window.
     * 
     * Step 2) of deleting a credential. Will close the modal window and delete
     * the credential.
     */
    @Command
     ...
     * 
     * Will update selected and possibly modified credential in the core
    ...
    /**
     * Event handler for the global command "resetCredentialPasswordConfirmed".
     * The event is triggered from the modal window for resetting the credential
     * password.
     * 
     * Step 2) of resetting the password. Will update selected credential with
     * returned password from the modal window The credential is updated in the
     * core component using REST API and update the model.
     * 
     * @param password
    ...
    /**
     * Event handler for the global command "createResourcePropertyConfirmed".
     * The event is triggered from the create resource property modal window.
     *
     ...
     * triggered from the environment configuration panel which posts the
     * command.
     * 
    ...
    /**
     * Event handler for the command "deleteResourcePropertyConfirmed". The
     * event is triggered from the confirm deletion modal window.
     * 
    ...
    /**
     * Event handler for the command "deleteResourcePropertyCancelled". The
     * event is triggered from the confirm deletion modal window.
     * 
     * Will close the modal window and abort the deletion.
     */
    ...
    /**
     * Event handler for the global command "refreshEnvironmentConfiguration".
     * The event is triggered from the menu controller and the environment
     * configuration panel which posts the global command.
     * 
     * Will trigger re-initialization of the environment configuration through
     * the creation of a core component from the web application factory.
     */
    @GlobalCommand
