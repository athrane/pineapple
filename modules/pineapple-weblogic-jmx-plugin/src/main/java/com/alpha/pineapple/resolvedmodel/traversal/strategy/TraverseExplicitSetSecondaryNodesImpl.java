...
public class TraverseExplicitSetSecondaryNodesImpl implements TraversalStrategy
{
    ...
    {        
        ...
        if(!resolvedtype.getSecondaryParticiant().getValueState().equals( ValueState.SET )) {
            
            // log debug message
            if ( logger.isDebugEnabled() )
            {
                StringBuilder message = new StringBuilder();
                message.append( "SKIPPING further traversal as secondary attribute isn't explicit set on resolved type <" );
