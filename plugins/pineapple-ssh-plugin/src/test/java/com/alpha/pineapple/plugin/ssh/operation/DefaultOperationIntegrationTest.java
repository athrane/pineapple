...
public class DefaultOperationIntegrationTest {
    ...
    /**
     * Test that operation can copy a single file.
     * With variable substitution enabled.
     * 
     * @throws Exception If test fails. 
     */
    @Test
    public void testCanCopySingleFileWithVariableSubstution() throws Exception
    {
		...
		// setup mocks
		expect(coreVariableSubstitutionProvider.createSubstitutedFile(
				EasyMock.isA(File.class), 
				EasyMock.isA(Session.class), 				
				EasyMock.isA(ExecutionResult.class))).andReturn(processedFile);						
    ...
    public void testCanCopySingleFileWithVariableSubstutionDisabled() throws Exception
    {
        ...
        // create content
        Object content = contentMother.createModelWithSingleFileCopy(localFile.getAbsolutePath(), remoteFileName, false);
    ...
    public void testCanCopyTwoFiles() throws Exception
    {
        ...
        // create remote file name
		String remoteFileName2 = new StringBuilder()
			.append(remoteSharedTestDirectory)
			.append("/")
			.append(randomFileName2)
			.toString();
		...
		expect(coreVariableSubstitutionProvider.createSubstitutedFile(
				EasyMock.isA(File.class), 
				EasyMock.isA(Session.class),				
				EasyMock.isA(ExecutionResult.class))).andReturn(processedFile2);								
		replay(coreVariableSubstitutionProvider);
    	expect(coreRuntimeDirectoryProvider.startsWithModulePathPrefix(isA(String.class)))
    		.andReturn(false)
    		.anyTimes();		
        ...
        // create content
        Object content = contentMother.createModelWithTwoFilesToCopy(
        		localFile.getAbsolutePath(), remoteFileName,
