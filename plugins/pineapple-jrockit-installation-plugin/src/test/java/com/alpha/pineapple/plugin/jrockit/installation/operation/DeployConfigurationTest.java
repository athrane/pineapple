...
/**
 * Unit test of the class <code>DeployConfiguration</code>.
 */
public class DeployConfigurationTest {
	...
	public void setUp() throws Exception {
        ...
        // create operation
        operation = new DeployConfiguration();
        ...
        // inject runner into operation
        ReflectionTestUtils.setField( operation, "asserter", asserter, Asserter.class );
     ...
     * <code>JrockitInstallation</code>.
     */
    @Test( expected = PluginExecutionFailedException.class )
    public void testFailsIfContentDoesntContainObjectOfJrockitInstallationType() throws Exception
    {
		// complete execution result initialization
		EasyMock.replay( executionResult );		
