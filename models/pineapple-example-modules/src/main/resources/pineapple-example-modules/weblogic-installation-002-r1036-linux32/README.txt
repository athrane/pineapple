...
Description
-------------
This example illustrates how to install WebLogic 10.3.6 on 32-bit Linux.
...
-----------------------
Download the WebLogic installer named "wls1036_linux32.bin" and place it in the "bin" directory.
