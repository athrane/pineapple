...
public class SessionRetryProxyFactoryIntegrationTest {
	...
	/**
	 * Session with no no-arg constructor, e.g. class has public n-arg constructor.
	 */
	...
	/**
	 * Session with no no-arg constructor, e.g. class has private n-arg constructor.
	 */
	...
	/**
	 * Subject under test. Instance is created by sessionRetryProxyFactoryFactory.
	 */
	...
	/**
	 * Test that session class with n-arg constructor can be handled and proxied.
	 * 
	...
	/**
	 * Test that session class with private no-arg constructor can be handled and
	 * proxied.
	 * 
	...
	/**
	 * Test that no information about a retry is registered on a successful connect.
	 * 
	 * @throws Exception
	 *             if test fails.
	 */
	...
	/**
	 * Test that session throws expected exception after exhausting the retry policy
	 * due to failed connects.
	 * 
	 * @throws Exception
	 *             if test fails.
	 */
