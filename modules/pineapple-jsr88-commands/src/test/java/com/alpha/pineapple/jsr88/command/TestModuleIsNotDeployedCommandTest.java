...
public class TestModuleIsNotDeployedCommandTest
{
    ...
    {
        command = new TestModuleIsNotDeployedCommand();        
    }
    ...
    public void testCommandFailsIfDescriptionKeyIsUndefinedInContext() throws Exception
    {
        ...
        context.put( TestModuleIsNotDeployedCommand.MANAGER_KEY, manager );                
        context.put( TestModuleIsNotDeployedCommand.MODULE_KEY, "deployed-app-1.0" );        
        context.put( TestModuleIsNotDeployedCommand.TARGETS_KEY, targets);        
    ...
    public void testCommandFailsIfDescriptionValueIsUndefinedInContext() throws Exception
    {
        ...
        Context context;
        context = new ContextBase();
        context.put( TestModuleIsNotDeployedCommand.DESCRIPTION_KEY, null );        
        context.put( TestModuleIsNotDeployedCommand.MANAGER_KEY, manager );                
        context.put( TestModuleIsNotDeployedCommand.MODULE_KEY, "deployed-app-1.0" );        
        context.put( TestModuleIsNotDeployedCommand.TARGETS_KEY, targets);        
    ...
    {        
        ...
        Context context;
        context = new ContextBase();
        context.put( TestModuleIsNotDeployedCommand.DESCRIPTION_KEY, "some test description" );                                       
        context.put( TestModuleIsNotDeployedCommand.MODULE_KEY, "deployed-app-1.0" );        
        context.put( TestModuleIsNotDeployedCommand.TARGETS_KEY, targets);        
    ...
    {        
        ...
        context = new ContextBase();
        context.put( TestModuleIsNotDeployedCommand.DESCRIPTION_KEY, "some test description" );
        context.put( TestModuleIsNotDeployedCommand.MANAGER_KEY, null );        
        context.put( TestModuleIsNotDeployedCommand.MODULE_KEY, "deployed-app-1.0" );        
        context.put( TestModuleIsNotDeployedCommand.TARGETS_KEY, targets);        
    ...
    public void testCommandFailsIfModuleValueIsUndefinedInContext() throws Exception
    {
        ...
        context.put( TestModuleIsNotDeployedCommand.DESCRIPTION_KEY, "some test description" );                                               
        context.put( TestModuleIsNotDeployedCommand.MANAGER_KEY, manager );
        context.put( TestModuleIsNotDeployedCommand.MODULE_KEY, null );        
        context.put( TestModuleIsNotDeployedCommand.TARGETS_KEY, targets);        
    ...
    public void testCommandFailsIfTargetsValueIsUndefinedInContext() throws Exception
    {
        ...
        context.put( TestModuleIsNotDeployedCommand.MANAGER_KEY, manager );          
        context.put( TestModuleIsNotDeployedCommand.MODULE_KEY, "deployed-app-1.0" );                
        context.put( TestModuleIsNotDeployedCommand.TARGETS_KEY, null );        
    ...
    /**
     * Test that execution of the test commands fails if module is deployed 
     * to zero targets.
     * 
     * existing targets = t1. 
     * expected targets = {}.
     ...
     */
    @Test
    public void testTestFailsIfModuleIsDeployedToZeroTargets() throws Exception
    {
        ...
        context.put( TestModuleIsNotDeployedCommand.DESCRIPTION_KEY, "some test description" );                        
        context.put( TestModuleIsNotDeployedCommand.MANAGER_KEY, manager );                
        context.put( TestModuleIsNotDeployedCommand.MODULE_KEY, WAR_MODULE );        
        context.put( TestModuleIsNotDeployedCommand.TARGETS_KEY, targets);        
     ...
     */
    @Test
    public void testTestFailsIfModuleIsDeployedToSingleTarget() throws Exception
    {
        final String TARGET = "target1";
        final String WAR_MODULE = "deployed-app-1.0";
     ...
     */
    @Test
    public void testTestFailsIfModuleIsDeployedToMultipleTarget() throws Exception
    {
        ...
        manager.targets.add( new MockTarget(TARGET2, "target1 description") );        
    ...
    /**
     * Test that execution of the test commands succeeds if module isn't 
     * deployed to single expected target.
     * 
     ...
     */
    @Test
    public void testTestSuccededIfModuleIsntDeployedToSingleTarget() throws Exception
    {
        final String TARGET1 = "t1";
        final String TARGET2 = "t2";        
        final String WAR_MODULE = "deployed-app-1.0";
    ...
    /**
     * Test that execution of the test commands succeeds if module isn't 
     * deployed to multiple expected targets.
     * 
     * existing targets = t1,t2. 
     ...
     */
    @Test
    public void testTestSuccededIfModuleIsntDeployedToMultipleTargets() throws Exception
    {
    ...
    /**
     * Test that execution of the test commands succeeds if module isn't 
     * deployed to expected target but to a different target.
     * 
     * existing targets = t1,t2. 
     * expected targets = t1.
     * actual targets = t2. 
     ...
     */
    @Test
    public void testTestSuccededIfModuleIsDeployedToDifferentTarget() throws Exception
    {
        final String TARGET1 = "target1";
        final String TARGET2 = "target2";        
        final String WAR_MODULE = "deployed-app-1.0";
    ...
    /**
     * Test that execution of the test commands succeeds if module isn't 
     * deployed to expected target but to different targets.
     * 
     * existing targets = t1,t2,t3. 
     * expected targets = t1.
     * actual targets = t2,t3. 
     * i.e. t1 != t2,t3  
     * 
     * @throws Exception
     */
    @Test
    public void testTestSuccededIfModuleIsDeployedToDifferentTargets() throws Exception
    {
        final String TARGET1 = "target1";
        final String TARGET2 = "target2";        
        ...
        manager.targets.add( new MockTarget(TARGET1, "target1 description") );
        manager.targets.add( new MockTarget(TARGET2, "target2 description") );        
        manager.targets.add( new MockTarget(TARGET3, "target3 description") );        

        // add deployment to mock manager
        manager.addMockWarModule( WAR_MODULE, TARGET2 );
        manager.addMockWarModule( WAR_MODULE, TARGET3 );        
     ...
     */
    @Test
    public void testTestFailsIfModuleTargetMatch() throws Exception
    {
        final String TARGET1 = "t1";
        final String TARGET2 = "t2";
        final String WAR_MODULE = "deployed-app-1.0";
