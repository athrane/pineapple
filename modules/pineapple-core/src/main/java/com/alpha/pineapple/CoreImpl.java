...
class CoreImpl implements PineappleCore {
     ...
     * 
     * Will attempt to load environment configuration file which contains
     * resource definitions from class path using the name "resources.xml".
     * 
     * @param provider
     *            Credential provider, which can provide credentials for
     *            external resources.
     * 
     ...
     * 
     * @return execution result from initialization. If component isn't
     ...
     * 
     * @param credential
     *            Defines absolute path where the credentials should be loaded
     *            from.
     * 
     * @throws CoreException
     *             If initialization fails.
