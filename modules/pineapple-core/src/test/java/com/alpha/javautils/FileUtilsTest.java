...
public class FileUtilsTest {
    ...
    /**
     * Test that file object which refers to a directory is returned unmodified
     * if the directory doesn't contain a '~' character.
     * 
     * @throws Exception
     *             If test fails.
     */
    ...
    /**
     * Test that file object which refers to a directory is converted if it
    ...
    /**
     * Test that method succeeds if path is in ""Documents and Settings"
     * directory.
     */
    @Test
    ...
    /**
     * Test that method fails if path isn't in ""Documents and Settings"
     * directory, e.g. user name doesn't match.
     */
    @Test
    ...
    /**
     * Test that method fails if path isn't in ""Documents and Settings"
     * directory, e.g. user name is missing.
     */
    @Test
    ...
    /**
     * Test that method fails if path isn't in ""Documents and Settings"
     * directory, e.g. leading separator is missing.
     */
    @Test
