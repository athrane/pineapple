...
/**
 * Helper class which is used to access properties from a {@link AssertionValues} object.
 */
public class AssertionValuesPropertyGetter
{
     ...
     * 
     * @return value of contained property. If the property is undefined then null is returned.
     * 
     */
