...
public class CreateImageCommandSystemTest {
    ...
    /**
     * Test that command can create Ubuntu base image with empty tag. and return
     * a single successful root result.
     * 
     * Due to the lack of tag, Docker with pull the tag with the "latest" tag
     * and some house keeping is required at the end of the test to clean up
     * properly.
     */
    ...
    /**
     * Test that command can create untagged busybox image with empty
     * tag. and return a single successful root result.
     * 
     * Due to the lack of tag, Docker with pull the tag with the "latest" tag
     * and some house keeping is required at the end of the test to clean
     * properly.
     */
    @SuppressWarnings("unchecked")
    @Test
    ...
    /**
     * Test that command can create tagged busybox image and return a
    ...
    /**
     * Test that command success if image already exists. A
     * busybox:latest image is created prior to creating the image
     * again.
     */
    @SuppressWarnings("unchecked")
    @Test
