...
/**
 * <p>
 * Implementation of the <code>org.apache.commons.chain.Command</code> interface which which tests 
 * the behavior of HTTP host(s) using the HTTP Get operation.
 * </p>
 * 
 * <p>
 ...
 * </li>
 * 
 * <li><code>requests</code> defines the number of times the URL which be invoked. The type is <code>int</code>.</li>
 *  
 * <li><code>reset</code> defines if HTTP session should reset after each sequence invocation. The type is
 * <code>boolean</code>.</li>
 *   
 * <li><code>http-configuration</code> contains configuration of the HTTP client with settings for TCP, HTTP and proxy server. 
 * The type is <code>com.alpha.pineapple.plugin.net.http.HttpConfiguration</code>.</li>   
 * 
