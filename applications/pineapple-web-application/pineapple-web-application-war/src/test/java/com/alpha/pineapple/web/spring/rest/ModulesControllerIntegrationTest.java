...
public class ModulesControllerIntegrationTest {
    ...
    /**
     * Test that POST "Refresh Modules" service invocation returns encoding
     * "utf-8".
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that DELETE "Delete Module" service invocation fails with HTTP 404
     * for unknown module.
     * 
     * @throws Exception
     *             if test fails.
    ...
    /**
     * Test that DELETE "Delete Model" service invocation result in the deletion
     * of the model from the model.
     * 
     * @throws Exception
     *             if test fails.
     */
    ...
    /**
     * Test that DELETE "Delete Model" service invocation returns HTTP 404 if
    ...
    /**
     * Test that POST "Create Model" service invocation returns HTTP 404 if
     * module doesn't exists.
     * 
     * @throws Exception
     *             if test fails.
