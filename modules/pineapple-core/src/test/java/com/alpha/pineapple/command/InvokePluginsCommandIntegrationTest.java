...
public class InvokePluginsCommandIntegrationTest {
	...
	/**
	 * Test that command can successfully execute with empty input and that expected
	 * messages are added to the result.
	 * 
	 * @throws Exception
	 *             If test fails.
	 */
	...
	/**
	 * Test that command can successfully execute with single model with an empty
	 * target resource value (i.e. empty string).
	 * 
	 * @throws Exception
	 *             If test fails.
	 */
	...
	/**
	 * Test that command fails to execute with single model with an unknown target
	 * resource value.
	 * 
	 * @throws Exception
	 *             If test fails.
	...
	/**
	 * Test that command fails to execute with single model with an target resource
	 * value on a plugin with no operations defined.
	 * 
	 * @throws Exception
	 *             If test fails.
	 */
	...
	/**
	 * Test that the continue-on-failure policy is activated by default if it isn't
	...
	/**
	 * Test that the continue-on-failure policy is activated if it is activated in
	 * the model.
	 * 
	 * This test case uses a mock policy object.
	 * 
	...
	/**
	 * Test that the continue-on-failure policy is deactivated if it is deactivated
	 * in the model.
	 * 
	...
	/**
	 * Test that the continue-on-failure policy is enforced if it is deactivated in
	 * the model and an abort signal has been given to the policy.
	 * 
	 * Model: The initial policy state is set to false (not default).
	 * 
	 * The result of setting it true is done by measuring the lack of added messages
	 * to the execution result regarding resolution of target resources and
	 * operation.
	 * 
	 * @throws Exception
	 *             If test fails.
	...
	/**
	 * Test that the continue-on-failure policy is set to default in model. and then
	 * the command is invoked again, e.g. through composite then the policy
	 * continue-on-failure can't be updated by the composite model to be disable the
	 * policy.
	 * 
	 * See PINEAPPLE-812: Verify a default policy can't be overwritten by a
	 * composite
	 * 
	 * Model: The initial policy state is set to true (default). Model2 (simulates
	 * composite): The initial policy state is set to false (not default).
	 * 
	 * @throws Exception
	 *             If test fails.
	 */
	 ...
	 * {@linkplain NullPointerException} is handled by termination of child result
	 * execution the model with an error and propagating the error to the root
	 * result.
	 * 
	 * @throws Exception
	 *             If test fails.
	 ...
	 * child result execution the model with an error and propagating the error to
	 * the root result.
	 * 
	 * @throws Exception
	 *             If test fails.
	...
	/**
	 * Test that execution of a plugin which throws channeled
	 * {@linkplain SessionDisconnectException} is handled by termination of child
	 * result execution the model with an error and propagating the error to the
	 * root result.
	 * 
	 * @throws Exception
	 ...
	 * execution makes the entire module execution fail. An unknown trigger is used
	 * for convenience in the test.
	 * 
	 * @throws Exception
	 *             If test fails.
	 */
