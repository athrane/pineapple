...
Description
-------------
This example illustrates how the infrastructure test can be used to monitor a Docker host 
and invoke a trigger to (re)start the host if it isn't running.
The trigger invokes the module named ssh-013-start-docker-host.
...
Intended operations
-----------------------
* "test" - will execute the test and invoke the trigger if the test fails.
