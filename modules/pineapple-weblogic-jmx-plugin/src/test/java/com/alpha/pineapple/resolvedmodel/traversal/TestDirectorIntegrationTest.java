...
/**
 * Integration test of the Spring configured bean named <code>testDirector</code>
...
public class TestDirectorIntegrationTest {
    ...
    public void testCanExecuteWithMinimalDomain() throws Exception 
    {
        ...
        // build
        testDirector.startTraversal(session, resolvedRoot, result);
        
        // result from builder
        System.out.println(result.getDescription());
        System.out.println(ReflectionToStringBuilder.toString(result.getChildren()));
