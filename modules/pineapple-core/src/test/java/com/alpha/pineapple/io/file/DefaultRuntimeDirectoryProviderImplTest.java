...
public class DefaultRuntimeDirectoryProviderImplTest {
     ...
     * <code>pineapple.home.dir</code> isn't defined. 2) The
     * <code>os.name</code>is Windows something-something 3) The
     * <code>user.home</code> is located at
     ...
     * <code>pineapple.home.dir</code> isn't defined. 2) The
     * <code>os.name</code>is Windows something-something 3) The
     * <code>user.home</code> is located at the root of the C drive. e.g. c:
     */
    @Test
    ...
    /**
     * Test that home directory is resolved to the directory defined by the
     * system property "pineapple.home.dir".
     */
    @Test
     ...
     * 
     * 1) The system property <code>pineapple.home.dir</code> isn't defined. 2)
     * The <code>os.name</code> is different from Windows something-something.
     */
    @Test
     ...
     * 
     * 1) The system property <code>pineapple.home.dir</code> isn't defined. 2)
     * The <code>os.name</code> is Windows something-something.
     * 
     * @throws Exception
     *             if test fails.
     */
     ...
     * 
     * 1) The system property <code>pineapple.home.dir</code> isn't defined. 2)
     * The <code>os.name</code> isn't Windows something-something.
     * 
     */
    @Test
    ...
    /**
     * Test that model path is resolved correctly for Linux, e.g. the
     * 'modulepath' identifier is resolved to the expected path.
     */
    @Test
    ...
    /**
     * Test that model path is resolved correctly for Linux, e.g. the
     * 'modulepath' identifier is resolved to the expected path, where the
     * modulepath is contains with a separator char, e.g modulepath:/bin
     * 
     * plea
     */
    @Test
    ...
    /**
     * Test that model path can be resolved from {@linkplain ExecutionResult}.
     * If path doesn't contain the variable name the original path is returned.
     */
    @Test
     ...
     * system property "pineapple.credentialprovider.password.file" is
     * undefined.
     */
    @Test
