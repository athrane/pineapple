...
Description
-------------
This example illustrates how to install WebLogic 12.1.2 on 64-bit Windows.
...
-----------------------
Download the WebLogic installer named "wls_121200.jar" and place it in the "bin" directory.
