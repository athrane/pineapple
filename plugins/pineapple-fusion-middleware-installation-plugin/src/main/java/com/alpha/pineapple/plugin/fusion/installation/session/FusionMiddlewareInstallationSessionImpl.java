...
package com.alpha.pineapple.plugin.fusion.installation.session;
 ...
 */
@PluginSession
public class FusionMiddlewareInstallationSessionImpl extends ProcessExecutionSessionImpl {
}
