...
public class MethodUtils {
	...
	/**
	 * // log debug message if (logger.isDebugEnabled()) { StringBuilder
	 * message = new StringBuilder(); message.append(
	 * "Starting to resolve getter methods from <" ); message.append(
	 * StringUtils.substringBefore( targetObject.toString(), "\n" ) );
	 * message.append( "> using attribute <" ); message.append(
	 * attributeName ); message.append( "> and method matcher <" );
	 * message.append( matcher ); message.append( ">." ); logger.debug(
	 * message.toString() ); }
	 **/
	 ...
	 * // log debug message if (logger.isDebugEnabled()) { StringBuilder
	 * message = new StringBuilder(); message.append(
	 * "Successfully resolved getters methods on object <" );
	 * message.append( StringUtils.substringBefore( targetObject.toString(),
	 * "\n" ) ); message.append( "> with result <" ); message.append(
	 * ReflectionToStringBuilder.toString( resultArray) ); message.append(
	 ...
	 * "Starting to resolve getter methods from <" ); message.append(
	 * StringUtils.substringBefore( targetObject.toString(), "\n" ) );
	 * message.append( "> using method matcher <" ); message.append( matcher
    ...
    /**
     * Return true if method returns a primitive, i.e. on of the eight standard
     * Java primitives: int, long, double, bool, byte short, float or char.
     * 
     * @param method
     *            method to test against.
     * 
    ...
    /**
     * Return true if method returns a primitive as object, i.e. one of the
     * eight standard Java primitives (Char excluded) as an object
     * representation: Integer, Long, Double, Boolean, Byte, Short or Float.
     * Char doesn't have an object representation.
     * 
     * @param method
     *            method to test against.
     * 
     ...
     * @param packageName
     *            Methods are only included from classes which are declared in
     *            the package or any sub packages. To return getters declared in
     *            any package supply the empty string as argument.
     * 
	 ...
	 * // log debug message if (logger.isDebugEnabled()) { StringBuilder
	 * message = new StringBuilder(); message.append(
	 * "Starting to process object <" ); message.append( targetObject );
	 * message.append(
	 * "> for getter methods which are declared by classes in package <" );
	 * message.append( packageName ); message.append( ">." ); logger.debug(
	 * message.toString() ); }
	 **/
	 ...
	 * // log debug message if (logger.isDebugEnabled()) { StringBuilder
	 * message = new StringBuilder(); message.append(
	 * "Successfully processed object <" ); message.append( targetObject );
	 * message.append( "> for getter methods <" ); message.append(
	 * ReflectionToStringBuilder.toString( resultArray) ); message.append(
	 * ">." ); logger.debug( message.toString() ); }
	 **/
