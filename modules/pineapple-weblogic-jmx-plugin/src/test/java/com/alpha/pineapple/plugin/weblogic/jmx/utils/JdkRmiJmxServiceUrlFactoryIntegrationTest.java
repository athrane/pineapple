...
/**
 * Integration test of the {@linkplain JdkRmiJmxServiceUrlFactoryImpl} class. 
 */
@RunWith( SpringJUnit4ClassRunner.class )
@ContextConfiguration( locations = { "/com.alpha.pineapple.plugin.weblogic.jmx-config.xml" } )
public class JdkRmiJmxServiceUrlFactoryIntegrationTest {

	/**
	 * Subject under test. 
	 */
	@Resource(name="jdkRmiJmxServiceUrlFactory")
	...
	/**
	 * Test service URL is created as expected for RMI.
	 * 
	 * @throws Exception If test fails.
	 */
	@Test
	public void testCreateEditMBeanServerUrlForRmi() throws Exception {
		...
		JMXServiceURL url = factory.createEditMBeanServerUrl(JmxProtool.JDK_RMI, randomHost, randomPort);				
