...
/**
 * Unit test of the {@link IsCookieMapsPairContainingNonEqualValues} class.
 */
public class IsCookieMapsPairContainingNonEqualValuesTest {
	...
	public void setUp() throws Exception {
		...
		matcher = IsCookieMapsPairContainingNonEqualValues.containsNonEqualValues();
	...
	/**
	 * Test that two maps with one entry identical fails.
	 */
	@Test
	public void testFailsWithTwoMapsContainingOneIdenticalEntry() {
	...
	/**
	 * Test that two maps with three identical entries fails.
	 */
	@Test
	public void testFailsWithTwoMapsContainingThreeIdentialEntries() {
	...
	/**
	 * Test that two maps with one different entry values succeeds.
	 */
	@Test
	public void testSucceedsWithTwoMapsContainingOneDifferentEntry() {
	...
	/**
	 * Test that two maps with three different entry values succeeds.
	 */
	@Test
	public void testSucceedsWithTwoMapsContainingThreeDifferentEntries() {
	 ...
	 */
	@Test
	public void testSucceedsWithTwoMapsContainingThreeDifferentEntries2() {
		...
		map1.put("key3", new Cookie(DOMAIN, "key3", "some-value"));
		CookieMap map2 = new CookieMap();
		map2.put("key1", new Cookie(DOMAIN, "key1", "some-value"));
		map2.put("key2", new Cookie(DOMAIN, "key2", "some-value"));
		map2.put("key3", new Cookie(DOMAIN, "key3", "another-value"));
