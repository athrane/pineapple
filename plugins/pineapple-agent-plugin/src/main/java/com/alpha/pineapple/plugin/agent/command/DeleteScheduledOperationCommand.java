...
import static com.alpha.pineapple.plugin.agent.AgentConstants.DELETE_SCHEDULED_OPERATION_URI;
 ...
 * which deletes a scheduled operation at Pineapple using the REST API.
 * 
 * <p>
