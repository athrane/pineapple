...
public class PasswordEncryptingCredentialConfigurationMarshallerImpl implements CredentialConfigurationMarshaller {
     ...
     * 
     * Encrypted password are validated by decrypting them. If decryption fails
     * then the password is treated as an unencrypted and is encrypted.
     * 
     ...
     * 
     * If an unencrypted password is encountered, e.g. without the prefix, then
