...
public interface CommandFacade {
	 ...
	 * @param targetClass root target JAXB generated class that XML file is
	 *                    marshalled into.
	 * @param result      root execution result. A child execution result is added
	 *                    to the root result. The child result describes the outcome
	 *                    of loading the file.
	 * 
	 ...
	 * 
	 * @param file   file to marshall objects to. If the file isn't specified as a
	 *               absolute path the the operation terminates with a failure. If
	 *               any directories in the path doesn't exist then they will be
	 *               created.
	 * @param root   Defines the root object in the object graph which should be
	 *               marshalled.
	 * @param result root execution result. A child execution result is added to the
	 *               root result. The child result describes the outcome of saving
	 *               the file.
	 * 
	 * @throws CommandFacadeException if save fails.
	 */
	 ...
	 * 
	 * @param modulesDirectory target directory for examples modules.
	 * @param result           root execution result. A child execution result is
	 *                         added to the root result. The child result describes
	 *                         the outcome of saving the file.
	 * 
	 * @throws CommandFacadeException if copy fails.
	 */
	void copyExampleModules(File modulesDirectory, ExecutionResult result);

	/**
	 * Initialise plugin activator.
	 * 
	 * @param provider      credential provider.
	 * @param configuration resource configuration.
	 * @param result        root execution result. A child execution result is added
	 *                      to the root result. The child result describes the
	 *                      outcome of the initialisation .
	 * 
	 * @return initialised plugin activator
	 * 
	 ...
	 * 
	 * @param model         aggregated model containing the triggers.
	 * @param executionInfo execution info.
	 * @param modelResult   model result. Used for reading the execution result to
	 *                      match trigger resolution directive to determine whether
	 *                      a trigger should be executed.
	 * @param result        model result. A child execution result is added to the
	 *                      model result. The child result describes the outcome of
	 *                      executing any triggers.
	 */
