...
Description
-------------
This example illustrates how to install WebLogic 10.3.6 on 32-bit Windows.
...
-----------------------
Download the WebLogic installer named "wls1036_win32.exe" and place it in the "bin" directory.
